...
FixWallAsphere::FixWallAsphere(LAMMPS *lmp, int narg, char **arg) :
  FixWall(lmp, narg, arg) {}

/* ---------------------------------------------------------------------- */

void FixWallAsphere::precompute(int m)
{
...
void FixWallAsphere::wall_particle(int m, int which, double coord)
{
  double delta;
