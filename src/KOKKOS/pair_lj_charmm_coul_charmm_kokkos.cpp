...
PairLJCharmmCoulCharmmKokkos<Space>::PairLJCharmmCoulCharmmKokkos(LAMMPS *lmp):PairLJCharmmCoulCharmm(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJCharmmCoulCharmmKokkos<Space>::~PairLJCharmmCoulCharmmKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairLJCharmmCoulCharmmKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairLJCharmmCoulCharmmKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJCharmmCoulCharmmKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJCharmmCoulCharmmKokkos<Space>::init_one(int i, int j)
{
  KK_FLOAT cutone = PairLJCharmmCoulCharmm::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJCharmmCoulCharmmKokkos<Device>;
template class PairLJCharmmCoulCharmmKokkos<Host>;
}
