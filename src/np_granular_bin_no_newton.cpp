...
#include <string.h>
#include "np_granular_bin_no_newton.h"
#include "neighbor.h"
...
NeighPairGranularBinNoNewton::NeighPairGranularBinNoNewton(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularBinNoNewton::build(NeighList *list)
{
