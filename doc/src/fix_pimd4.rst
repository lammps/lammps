...
* keyword = *ensemble* or *integrator* or *temp* or *tau* or *thermostat* or *press* or *taup*

  .. parsed-literal::

       *ensemble* value = *nve* or *nvt* or *nph* or *npt*
       *thermostat* value = *PILE_L* or *PILE_G*
       *tau* value = dampling time of the thermostat
...
Output info
"""""""""""
This fix returns a global vector containing several thermodynamic estimators.
