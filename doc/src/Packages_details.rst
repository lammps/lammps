...
:doc:`GPU package <Speed_gpu>` doc page gives details of what hardware and GPU
...
:doc:`USER-INTEL package <Speed_intel>` doc page gives details of what hardware and
...
The :doc:`USER-OMP package <Speed_omp>` doc page gives details of what hardware
