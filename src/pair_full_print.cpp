...
PairFullPrint::PairFullPrint(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
}
...
void PairFullPrint::compute(int eflag, int vflag)
{
...
void PairFullPrint::settings(int narg, char **arg)
{
...
void PairFullPrint::coeff(int narg, char **arg)
{
  if (narg < 3 || narg > 4)
...
double PairFullPrint::init_one(int i, int j)
{
...
void PairFullPrint::write_restart(FILE *fp)
{
...
void PairFullPrint::read_restart(FILE *fp)
{
...
void PairFullPrint::write_restart_settings(FILE *fp)
{
...
void PairFullPrint::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairFullPrint::write_data(FILE *fp)
{
...
void PairFullPrint::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairFullPrint::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void *PairFullPrint::extract(const char *str, int &dim)
{
  dim = 2;
