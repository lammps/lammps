/*
  ...
  SELM_Integrator class associated with the given data type.  This
...
#ifndef SELM_INTEGRATOR_DELEGATOR_XML_HANDLER_H
#define SELM_INTEGRATOR_DELEGATOR_XML_HANDLER_H
...
class SELM_Integrator_Delegator_XML_Handler : public Atz_XML_SAX_DataHandler {
 ...
 public:
  ...
  /* ======================== Function prototypes ======================= */
  SELM_Integrator_Delegator_XML_Handler();
  virtual ~SELM_Integrator_Delegator_XML_Handler();

  string         xmlTagName_xml;
  string         xmlTagName_SELM_Integrator;
  string         xmlTagName_IntegratorName;
  string         xmlTagName_IntegratorTypeStr;
