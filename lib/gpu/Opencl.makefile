...
$(OBJ_DIR)/neighbor_cpu_cl.h: neighbor_cpu.cu
	$(BSH) ./geryon/file_to_cstr.sh neighbor_cpu.cu $(OBJ_DIR)/neighbor_cpu_cl.h
...
$(OBJ_DIR)/device_cl.h: device.cu
	$(BSH) ./geryon/file_to_cstr.sh device.cu $(OBJ_DIR)/device_cl.h
...
$(OBJ_DIR)/pppm_cl.h: pppm.cu
	$(BSH) ./geryon/file_to_cstr.sh pppm.cu $(OBJ_DIR)/pppm_cl.h;
