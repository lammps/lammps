...
Fingerprint_bondscreenedspin::Fingerprint_bondscreenedspin(PairRANN *pair) : Fingerprint(pair)
{
	n_body_type = 3;
	dr = 0;
	re = 0;
...
bool Fingerprint_bondscreenedspin::parse_values(char * constant, char * line1){
...
void Fingerprint_bondscreenedspin::init(int *i,int id){
...
//						dBbz1[a2] -= dBbz;
						...
						dfeaturesy[ai] += dBby;
						dfeaturesz[ai] += dBbz;
						dspinx[ai] += yprod*Bbs[a2]*coeff[a2]*si[0];
						dspiny[ai] += yprod*Bbs[a2]*coeff[a2]*si[1];
						dspinz[ai] += yprod*Bbs[a2]*coeff[a2]*si[2];
						dspinx[ai-jj*f+jnum*f] += yprod*Bbs[a2]*coeff[a2]*sj[0];
						dspiny[ai-jj*f+jnum*f] += yprod*Bbs[a2]*coeff[a2]*sj[1];
						dspinz[ai-jj*f+jnum*f] += yprod*Bbs[a2]*coeff[a2]*sj[2];
						yprod *= y4[M[a2+1]];
						ai++;
						for (kk=0;kk<jnum;kk++){
...
//						dBbz1[a2] -= dBbz;
						...
						dfeaturesy[ai] += dBby;
						dfeaturesz[ai] += dBbz;
						dspinx[ai] += Bgs[a2]*yprod*coeff[a2]*si[0];
						dspiny[ai] += Bgs[a2]*yprod*coeff[a2]*si[1];
						dspinz[ai] += Bgs[a2]*yprod*coeff[a2]*si[2];
						dspinx[ai-jj*f+jnum*f] += yprod*Bgs[a2]*coeff[a2]*sj[0];
						dspiny[ai-jj*f+jnum*f] += yprod*Bgs[a2]*coeff[a2]*sj[1];
						dspinz[ai-jj*f+jnum*f] += yprod*Bgs[a2]*coeff[a2]*sj[2];
						yprod *= y4[M[a2+1]];
						ai++;
						for (kk=0;kk<jnum;kk++){
							if (Bij[kk]==false){continue;}
				...
				for (a2=a;a2<mb;a2++){
					...
					features[ai-jnum*f] += Bbs[a2]*Bgs[a2]*coeff[a2];
...
//						dBbz1[a2] -= dBbz;
						...
						dfeaturesy[ai] += dBby;
						dfeaturesz[ai] += dBbz;
						dspinx[ai] += 2*Bbs[a2]*yprod*coeff[a2]*si[0];
						dspiny[ai] += 2*Bbs[a2]*yprod*coeff[a2]*si[1];
						dspinz[ai] += 2*Bbs[a2]*yprod*coeff[a2]*si[2];
						dspinx[ai-jj*f+jnum*f] += 2*yprod*Bbs[a2]*coeff[a2]*sj[0];
						dspiny[ai-jj*f+jnum*f] += 2*yprod*Bbs[a2]*coeff[a2]*sj[1];
						dspinz[ai-jj*f+jnum*f] += 2*yprod*Bbs[a2]*coeff[a2]*sj[2];
						yprod *= y4[M[a2+1]];
						ai++;
						for (kk=0;kk<jnum;kk++){
							if (Bij[kk]==false){continue;}
				...
				for (a2=a;a2<mb;a2++){
					ai = n*(mb)+a2+count+jnum*f;
					features[ai-jnum*f] += Bbs[a2]*Bbs[a2]*coeff[a2];
//					dfeaturesx[ai] += dBbx1[a2];
//					dfeaturesy[ai] += dBby1[a2];
//					dfeaturesz[ai] += dBbz1[a2];
				}
...
//				dspinx[jnum*f+count]+=dspinx[jj*f+count];
//				dspiny[jnum*f+count]+=dspiny[jj*f+count];
//				dspinz[jnum*f+count]+=dspinz[jj*f+count];
				count++;
			}
		}
	}
...
int Fingerprint_bondscreenedspin::factorial(int n) {
   if ((n==0)||(n==1))
      return 1;
   else
