...
* Itype,Jtype = two atom types to swap with each othher
...
other moleclules with atoms of Jtype.  The fix will select a random
...
Second, consider diblock copolymers with two types of monomers Itype
...
two flavors of diblock copolymers.

Intra-molecular swaps of atom types are attemped every N timesteps.  On
