...
#include "pair_born_coul_long_cs_kokkos.h"
...
PairBornCoulLongCSKokkos<DeviceType>::PairBornCoulLongCSKokkos(LAMMPS *lmp) : PairBornCoulLongCS(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairBornCoulLongCSKokkos<DeviceType>::~PairBornCoulLongCSKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairBornCoulLongCSKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if (ncoultablebits)
    ev = pair_compute<PairBornCoulLongCSKokkos<DeviceType>,CoulLongTable<1>>
      (this,(NeighListKokkos<DeviceType>*)list);
  else
    ev = pair_compute<PairBornCoulLongCSKokkos<DeviceType>,CoulLongTable<0>>
      (this,(NeighListKokkos<DeviceType>*)list);
...
template<class DeviceType>
void PairBornCoulLongCSKokkos<DeviceType>::allocate()
{
  PairBornCoulLongCS::allocate();
  ...
  k_params = Kokkos::DualView<params_born_coul_long**,Kokkos::LayoutRight,DeviceType>("PairBornCoulLongCS::params",n+1,n+1);
  params = k_params.template view<DeviceType>();
}

template<class DeviceType>
void PairBornCoulLongCSKokkos<DeviceType>::init_tables(double cut_coul, double *cut_respa)
{
...
template<class DeviceType>
void PairBornCoulLongCSKokkos<DeviceType>::init_style()
{
  PairBornCoulLongCS::init_style();
...
template<class DeviceType>
double PairBornCoulLongCSKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairBornCoulLongCS::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairBornCoulLongCSKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class PairBornCoulLongCSKokkos<LMPHostType>;
#endif
}
