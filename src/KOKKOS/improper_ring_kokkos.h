...
// clang-format off
ImproperStyle(ring/kk,ImproperRingKokkos<LMPDeviceType>);
ImproperStyle(ring/kk/device,ImproperRingKokkos<LMPDeviceType>);
ImproperStyle(ring/kk/host,ImproperRingKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_RING_KOKKOS_H
#define LMP_IMPROPER_RING_KOKKOS_H
...
struct TagImproperRingCompute{};

template<class DeviceType>
class ImproperRingKokkos : public ImproperRing {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperRingKokkos(class LAMMPS *);
  ~ImproperRingKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperRingCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperRingCompute<NEWTON_BOND,EVFLAG>, const int&) const;
