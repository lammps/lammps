...
// clang-format off
ImproperStyle(inversion/harmonic/kk,ImproperInversionHarmonicKokkos<LMPDeviceType>);
ImproperStyle(inversion/harmonic/kk/device,ImproperInversionHarmonicKokkos<LMPDeviceType>);
ImproperStyle(inversion/harmonic/kk/host,ImproperInversionHarmonicKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_INVERSION_HARMONIC_KOKKOS_H
#define LMP_IMPROPER_INVERSION_HARMONIC_KOKKOS_H
...
struct TagImproperInversionHarmonicCompute{};

template<class DeviceType>
class ImproperInversionHarmonicKokkos : public ImproperInversionHarmonic {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperInversionHarmonicKokkos(class LAMMPS *);
  ~ImproperInversionHarmonicKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperInversionHarmonicCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperInversionHarmonicCompute<NEWTON_BOND,EVFLAG>, const int&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void invang(EV_FLOAT &ev, const int i1, const int i2, const int i3, const int i4,
              const int type,
...
// NOLINTNEXTLINE
 ...
 protected:
  ...
  DAT::tdual_kkfloat_1d k_kw;
  DAT::tdual_kkfloat_1d k_w0;

  typename AT::t_kkfloat_1d d_kw;
  typename AT::t_kkfloat_1d d_w0;
