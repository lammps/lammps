...
#include <cstdlib>
#include <cstring>
#include "pair_cac_eam_alloy_interp.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
#include "memory.h"
...
PairCACEAMAlloyInterp::PairCACEAMAlloyInterp(LAMMPS *lmp) : PairCACEAMInterp(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairCACEAMAlloyInterp::coeff(int narg, char **arg)
{
  int i,j;
...
void PairCACEAMAlloyInterp::read_file(char *filename)
{
  Setfl *file = setfl;
...
void PairCACEAMAlloyInterp::file2array()
{
  int i,j,m,n;
