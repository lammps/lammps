...
#include "np_respa_bin_no_newton_omp.h"
...
NeighPairRespaBinNoNewtonOmp::NeighPairRespaBinNoNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairRespaBinNoNewtonOmp::build(NeighList *list)
{
