...
PairTableOMP::PairTableOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  ntables = 0;
  tables = NULL;
}
...
void PairTableOMP::settings(int narg, char **arg)
{
...
void PairTableOMP::coeff(int narg, char **arg)
{
...
double PairTableOMP::init_one(int i, int j)
{
...
void PairTableOMP::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairTableOMP::bcast_table(Table *tb)
{
...
void PairTableOMP::spline_table(Table *tb)
{
  tb->e2file = (double *) 
...
void PairTableOMP::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = 0;
  tb->fpflag = 0;
...
void PairTableOMP::null_table(Table *tb)
{
...
void PairTableOMP::free_table(Table *tb)
{
...
void PairTableOMP::spline(double *x, double *y, int n,
...
void PairTableOMP::write_restart(FILE *fp)
{
...
void PairTableOMP::read_restart(FILE *fp)
{
...
void PairTableOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairTableOMP::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairTableOMP::extract(char *str, int &dim)
{
