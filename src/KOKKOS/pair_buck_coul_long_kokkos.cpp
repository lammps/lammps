...
PairBuckCoulLongKokkos<Space>::PairBuckCoulLongKokkos(LAMMPS *lmp):PairBuckCoulLong(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairBuckCoulLongKokkos<Space>::~PairBuckCoulLongKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::cleanup_copy() {
  allocated = 0;
  cutsq = NULL;
  cut_ljsq = NULL;
  eatom = NULL;
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairBuckCoulLongKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairBuckCoulLongKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairBuckCoulLongKokkos<Space>::
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairBuckCoulLongKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairBuckCoulLongKokkos<Space>::init_one(int i, int j)
{
...
namespace LAMMPS_NS {
template class PairBuckCoulLongKokkos<Device>;
template class PairBuckCoulLongKokkos<Host>;
}
