...
# PACKAGE    = all supported packages
...
PACKBASIC = molecule kspace manybody rigid graphics
...
lib-%:
	@if [ -e ../lib/$(LIBDIR)/Install.py ]; then \
	  ...
	  echo "Install script for lib $(@:lib-%=%) does not exist. Please use CMake."; \
	fi; touch main.cpp
