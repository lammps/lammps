...
#ifndef SELM_INTERACTION_CUSTOM1_XML_HANDLER_H
#define SELM_INTERACTION_CUSTOM1_XML_HANDLER_H
...
class SELM_Interaction_CUSTOM1_XML_Handler : public Atz_XML_SAX_DataHandler {

 public:

  /* ======================== Function prototypes ======================= */
  SELM_Interaction_CUSTOM1_XML_Handler();
  SELM_Interaction_CUSTOM1_XML_Handler(SELM_Interaction_Delegator_XML_Handler *delegatorHandler);

  virtual ~SELM_Interaction_CUSTOM1_XML_Handler();
  ...
  friend class SELM_Interaction_CUSTOM1;

  SELM_Interaction_CUSTOM1 *interaction; /* object to construct */
