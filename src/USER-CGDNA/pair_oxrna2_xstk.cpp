...
void PairOxrna2Xstk::coeff(int narg, char **arg)
{
  ...
  a_xst7_one = force->numeric(FLERR,arg[16]);
  theta_xst7_0_one = force->numeric(FLERR,arg[17]);
  dtheta_xst7_ast_one = force->numeric(FLERR,arg[18]);

  a_xst8_one = force->numeric(FLERR,arg[19]);
  theta_xst8_0_one = force->numeric(FLERR,arg[20]);
  dtheta_xst8_ast_one = force->numeric(FLERR,arg[21]);
