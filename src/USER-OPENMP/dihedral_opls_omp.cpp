...
DihedralOPLSOMP::DihedralOPLSOMP(LAMMPS *lmp) : DihedralOMP(lmp) {}

/* ---------------------------------------------------------------------- */

DihedralOPLSOMP::~DihedralOPLSOMP()
{
  if (allocated) {
...
void DihedralOPLSOMP::coeff(int which, int narg, char **arg)
{
  if (which > 0) return;
...
void DihedralOPLSOMP::write_restart(FILE *fp)
{
...
void DihedralOPLSOMP::read_restart(FILE *fp)
{
  allocate();
...
double DihedralOPLSOMP::memory_usage()
{
