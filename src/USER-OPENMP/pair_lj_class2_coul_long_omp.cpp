...
PairLJClass2CoulLongOMP::PairLJClass2CoulLongOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairLJClass2CoulLongOMP::~PairLJClass2CoulLongOMP()
{
  if (allocated) {
...
void PairLJClass2CoulLongOMP::eval()
{
...
void PairLJClass2CoulLongOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJClass2CoulLongOMP::settings(int narg, char **arg)
{
...
void PairLJClass2CoulLongOMP::coeff(int narg, char **arg)
{
...
void PairLJClass2CoulLongOMP::init_style()
{
  if (!atom->q_flag)
...
double PairLJClass2CoulLongOMP::init_one(int i, int j)
{
...
void PairLJClass2CoulLongOMP::write_restart(FILE *fp)
{
...
void PairLJClass2CoulLongOMP::read_restart(FILE *fp)
{
...
void PairLJClass2CoulLongOMP::write_restart_settings(FILE *fp)
{
...
void PairLJClass2CoulLongOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJClass2CoulLongOMP::single(int i, int j, int itype, int jtype,
				    double rsq,
...
void *PairLJClass2CoulLongOMP::extract(char *str, int &dim)
{
  dim = 0;
