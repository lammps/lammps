...
PairStyle(lj/cut/tip4p/dsf,PairLJCutTIP4PDSF)

#else

#ifndef LMP_PAIR_LJ_CUT_TIP4P_DSF_H
#define LMP_PAIR_LJ_CUT_TIP4P_DSF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutTIP4PDSF : public Pair {
 public:
  PairLJCutTIP4PDSF(class LAMMPS *);
  virtual ~PairLJCutTIP4PDSF();
