...
#include <string.h>
#include "np_granular_bin_newton_omp.h"
...
NeighPairGranularBinNewtonOmp::NeighPairGranularBinNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularBinNewtonOmp::build(NeighList *list)
{
