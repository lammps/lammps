...
TEST(TestDEM01, plain)
{
    if (test_config.skip_tests.count(test_info_->name())) GTEST_SKIP();

    LAMMPS::argv args = {"TestDEM01", "-log", "none", "-echo", "screen", "-nocite"};
