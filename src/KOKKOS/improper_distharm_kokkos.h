...
// clang-format off
ImproperStyle(distharm/kk,ImproperDistHarmKokkos<LMPDeviceType>);
ImproperStyle(distharm/kk/device,ImproperDistHarmKokkos<LMPDeviceType>);
ImproperStyle(distharm/kk/host,ImproperDistHarmKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_DISTHARM_KOKKOS_H
#define LMP_IMPROPER_DISTHARM_KOKKOS_H
...
struct TagImproperDistHarmCompute{};

template<class DeviceType>
class ImproperDistHarmKokkos : public ImproperDistHarm {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperDistHarmKokkos(class LAMMPS *);
  ~ImproperDistHarmKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperDistHarmCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperDistHarmCompute<NEWTON_BOND,EVFLAG>, const int&) const;
