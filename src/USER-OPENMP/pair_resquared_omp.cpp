...
PairRESquaredOMP::~PairRESquaredOMP()
{
  if (allocated) {
...
void PairRESquaredOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairRESquaredOMP::settings(int narg, char **arg)
{
...
void PairRESquaredOMP::coeff(int narg, char **arg)
{
  if (narg < 10 || narg > 11)
...
void PairRESquaredOMP::init_style()
{
...
double PairRESquaredOMP::init_one(int i, int j)
{
...
void PairRESquaredOMP::write_restart(FILE *fp)
{
...
void PairRESquaredOMP::read_restart(FILE *fp)
{
...
void PairRESquaredOMP::write_restart_settings(FILE *fp)
{
...
void PairRESquaredOMP::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairRESquaredOMP::precompute_i(const int i,RE2Vars &ws) {
...
double PairRESquaredOMP::det_prime(const double m[3][3], const double m2[3][3])
{
  double ans;
...
double PairRESquaredOMP::resquared_analytic(const int i, const int j,
...
double PairRESquaredOMP::resquared_lj(const int i, const int j,
