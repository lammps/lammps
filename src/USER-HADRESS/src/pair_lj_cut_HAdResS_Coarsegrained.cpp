...
#include "stdlib.h"
#include "string.h"
#include "pair_lj_cut_HAdResS_Coarsegrained.h"
#include "atom.h"
#include "atom_vec.h"
#include "comm.h"
#include "force.h"
...
PairLJCutHADRESSCOARSEGRAINED::PairLJCutHADRESSCOARSEGRAINED(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
...
PairLJCutHADRESSCOARSEGRAINED::~PairLJCutHADRESSCOARSEGRAINED()
{
...
void PairLJCutHADRESSCOARSEGRAINED::compute(int eflag, int vflag)
{
...
void PairLJCutHADRESSCOARSEGRAINED::compute_inner()
{
...
void PairLJCutHADRESSCOARSEGRAINED::compute_middle()
{
    error->all(FLERR,"Rrespa has not been included!");
...
void PairLJCutHADRESSCOARSEGRAINED::compute_outer(int eflag, int vflag)
{
    error->all(FLERR,"Rrespa has not been included!");
}
...
void PairLJCutHADRESSCOARSEGRAINED::allocate()
{
...
void PairLJCutHADRESSCOARSEGRAINED::settings(int narg, char **arg)
{
...
void PairLJCutHADRESSCOARSEGRAINED::coeff(int narg, char **arg)
{
...
void PairLJCutHADRESSCOARSEGRAINED::init_style()
{
...
void PairLJCutHADRESSCOARSEGRAINED::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairLJCutHADRESSCOARSEGRAINED::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJCutHADRESSCOARSEGRAINED::write_restart(FILE *fp)
{
...
void PairLJCutHADRESSCOARSEGRAINED::read_restart(FILE *fp)
{
...
void PairLJCutHADRESSCOARSEGRAINED::write_restart_settings(FILE *fp)
{
...
void PairLJCutHADRESSCOARSEGRAINED::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairLJCutHADRESSCOARSEGRAINED::write_data(FILE *fp)
{
...
void PairLJCutHADRESSCOARSEGRAINED::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairLJCutHADRESSCOARSEGRAINED::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairLJCutHADRESSCOARSEGRAINED::extract(const char *str, int &dim)
{
  dim = 2;
...
int PairLJCutHADRESSCOARSEGRAINED::molecules_in_group(tagint &idlo, tagint &idhi)
{
  int i;
...
void PairLJCutHADRESSCOARSEGRAINED::CG_Print_Compensation_Energy(){
...
void PairLJCutHADRESSCOARSEGRAINED::CG_Update_Compensation_Energy(){
...
void PairLJCutHADRESSCOARSEGRAINED::Load_Compensation_Pressure(){
...
void PairLJCutHADRESSCOARSEGRAINED::H_AdResS_Allocation(){
