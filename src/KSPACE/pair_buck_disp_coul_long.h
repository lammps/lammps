...
PairStyle(buck/disp/coul/long,PairBuckDispCoulLong)

#else

#ifndef LMP_PAIR_BUCK_DISP_COUL_LONG_H
#define LMP_PAIR_BUCK_DISP_COUL_LONG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBuckDispCoulLong : public Pair {
 public:
  double cut_coul;

  PairBuckDispCoulLong(class LAMMPS *);
