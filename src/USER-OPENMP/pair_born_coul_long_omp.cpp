...
PairBornCoulLongOMP::PairBornCoulLongOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairBornCoulLongOMP::~PairBornCoulLongOMP()
{
  if (allocated) {
...
void PairBornCoulLongOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBornCoulLongOMP::settings(int narg, char **arg)
{
...
void PairBornCoulLongOMP::coeff(int narg, char **arg)
{
...
double PairBornCoulLongOMP::init_one(int i, int j)
{
...
void PairBornCoulLongOMP::init_style()
{
  if (!atom->q_flag)
...
void PairBornCoulLongOMP::write_restart(FILE *fp)
{
...
void PairBornCoulLongOMP::read_restart(FILE *fp)
{
...
void PairBornCoulLongOMP::write_restart_settings(FILE *fp)
{
...
void PairBornCoulLongOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairBornCoulLongOMP::single(int i, int j, int itype, int jtype,
				double rsq, 
...
void *PairBornCoulLongOMP::extract(char *str, int &dim)
{
  dim = 0;
