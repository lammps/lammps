...
/* ---------------------------------------------------------------------- */
const int   SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::TYPE     = SELM_Lagrangian_Types::TYPE_LAMMPS_ATOM_STYLE_ELLIPSOID;
const char* SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::TYPE_STR = SELM_Lagrangian_Types::TYPE_STR_LAMMPS_ATOM_STYLE_ELLIPSOID;

const char *SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::error_str_code = "SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID.cpp";
// could use instead the pre-processor constant to get file automatically!
// char *SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::error_str_code = __FILE__;
// can also give line numbers by using __LINE__  (int type)  [Compiler substitutes]

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_NULL                = 0;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_NULL             = "NULL";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_SELM                = 1;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_SELM             = "SELM";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_VTK                 = 2;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_VTK              = "vtk";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_VTK_LEGACY          = 3;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_VTK_LEGACY       = "VTK_legacy";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_ATOM_ID             = 4;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_ATOM_ID          = "atomID";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_VELOCITY            = 5;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_VELOCITY         = "velocity";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPE_FORCE               = 6;
const char*  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TYPESTR_FORCE            = "force";

const int    SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::OUTPUTFLAG_TOTAL_NUM                = 7;

SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID() : SELM_Lagrangian() {
...
SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID(int narg, char **arg) : SELM_Lagrangian(narg, arg) {

  const char *error_str_func = "SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID()";
...
SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID(class LAMMPS *lmps, class DriverSELM *fx) {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::init() {

  type = SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::TYPE;
  strcpy(typeStr, SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::TYPE_STR);
  ...
  SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID_Params = NULL;
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::setup() {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::setControlPtsDataFromLammpsData() {
  ...
  */
  ...
  for (k = 0; k < num_LAMMPS_atoms; k++) {
    // we assume the Lagrangian stores all types...
  ...
  if (numControlPts_alloc < numControlPts) {
    ...
    /* Need to add collection of orientation information */
    N         = num_dim*numControlPts;
    if (pt_Vel != NULL) {
      free(pt_Vel);
    }
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::setLammpsDataFromControlPtsData() {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::packageError(int code, void *extras) {
    exit(code);
}



void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::userAppl_writePtsVTKFile(const char          *filename,
                              int            num_dim,
                              int            numPtsX,
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeSimulationDataToDisk(const char *baseFilename, int timeIndex) {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::setSimulationOutputFlags(const char *outputFlagStr) {
  ...
  if (strcmp(outputFlagStr,"all") == 0) {
    ...
    strcpy(parseStr,outputFlagStr); // avoids destroying original string
    char *p        = strtok(parseStr, " "); // @optimization: PJA: WARNING uses fixed size string
    int  k         = 0;
    int  numTokens = 0;
    while (p) {
      //printf ("Token: %s\n", p);
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::resetSimulationOutputFlags() {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeVTKLegacy(const char *baseFilename, int timeIndex) {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeVTKLegacy(const char *filename) {
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeSELM(const char *baseFilename, int timeIndex) {
  char filename[10000];
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeSELM(const char *filename) {
  ...
  /* open the file for writing the data */
      ...
      fprintf(fid, "-- SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID : Simulation Data -- \n");
      fprintf(fid, "\n");
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeVTK(const char *baseFilename, int timeIndex) {
  char filename[10000];
...
void SELM_Lagrangian_LAMMPS_ATOM_STYLE_ELLIPSOID::writeVTK(const char *filename) {
