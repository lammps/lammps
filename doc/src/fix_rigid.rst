...
the bodies are thermostatted to the same target temperature.  The
*kk* styles run on 3d systems only.  Reading body properties from a
file (the *infile* keyword) is experimental.
