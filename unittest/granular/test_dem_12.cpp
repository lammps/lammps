...
// DEM verification test 12: superellipsoid collision (momentum and angular momentum conservation).
// All test logic is shared via test_dem_common; the reference systems
// live in tests/dem12-*.yaml.
