...
FixShearHistoryOMP::FixShearHistoryOMP(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
  restart_peratom = 1;
  create_attribute = 1;
...
FixShearHistoryOMP::~FixShearHistoryOMP()
{
...
int FixShearHistoryOMP::setmask()
{
  int mask = 0;
  mask |= PRE_EXCHANGE;
  return mask;
...
double FixShearHistoryOMP::memory_usage()
{
  int nmax = atom->nmax;
...
void FixShearHistoryOMP::grow_arrays(int nmax)
{
...
void FixShearHistoryOMP::copy_arrays(int i, int j)
{
...
void FixShearHistoryOMP::set_arrays(int i)
{
  npartner[i] = 0;
}
...
int FixShearHistoryOMP::pack_exchange(int i, double *buf)
{
  int m = 0;
  buf[m++] = npartner[i];
...
int FixShearHistoryOMP::unpack_exchange(int nlocal, double *buf)
{
  int m = 0;
...
int FixShearHistoryOMP::pack_restart(int i, double *buf)
{
  int m = 0;
...
void FixShearHistoryOMP::unpack_restart(int nlocal, int nth)
{
...
int FixShearHistoryOMP::maxsize_restart()
{
  return 4*MAXTOUCH + 2;
}
...
int FixShearHistoryOMP::size_restart(int nlocal)
{
