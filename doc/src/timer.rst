...
information about the timing output, see the :doc:`Run output
<Run_output>` doc page.
...
accessed with the :doc:`thermo <thermo_style>` variable *timeremain*,
...
:doc:`r-RESPA runs <run_style>`, respectively.  Checking for timeout too
