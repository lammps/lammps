...
#include "np_respa_bin_newton_tri_omp.h"
...
NeighPairRespaBinNewtonTriOmp::NeighPairRespaBinNewtonTriOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairRespaBinNewtonTriOmp::build(NeighList *list)
{
