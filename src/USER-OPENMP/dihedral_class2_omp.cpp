...
DihedralClass2OMP::DihedralClass2OMP(LAMMPS *lmp) : DihedralOMP(lmp)
{
  PI = 4.0*atan(1.0);
}
...
DihedralClass2OMP::~DihedralClass2OMP()
{
  if (allocated) {
...
#pragma omp parallel default(shared)
#endif
  {
    ...
    int i1,i2,i3,i4,i,j,k,n,type,tid;
	...
	f[i4][2] += fabcd[3][2];
      ...
      if (EVFLAG)
	ev_tally_thr(i1,i2,i3,i4,nlocal,NEWTON_BOND,edihedral,
...
void DihedralClass2OMP::allocate()
{
  allocated = 1;
...
void DihedralClass2OMP::coeff(int which, int narg, char **arg)
{
  if (which < 0 || which > 5)
...
void DihedralClass2OMP::write_restart(FILE *fp)
{
...
void DihedralClass2OMP::read_restart(FILE *fp)
{
  allocate();
...
double DihedralClass2OMP::memory_usage()
{
