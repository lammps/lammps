...
DihedralOPLSKokkos<Space>::DihedralOPLSKokkos(LAMMPS *lmp) : DihedralOPLS(lmp)
{
...
template<ExecutionSpace Space>
DihedralOPLSKokkos<Space>::~DihedralOPLSKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void DihedralOPLSKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
...
void DihedralOPLSKokkos<Space>::operator()(TagDihedralOPLSCompute<NEWTON_BOND,EVFLAG>, const int &n, EV_FLOAT& ev) const {
...
template<int NEWTON_BOND, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void DihedralOPLSKokkos<Space>::operator()(TagDihedralOPLSCompute<NEWTON_BOND,EVFLAG>, const int &n) const {
  EV_FLOAT ev;
...
template<ExecutionSpace Space>
void DihedralOPLSKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void DihedralOPLSKokkos<Space>::coeff(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void DihedralOPLSKokkos<Space>::read_restart(FILE *fp)
{
...
KOKKOS_INLINE_FUNCTION
void DihedralOPLSKokkos<Space>::ev_tally(EV_FLOAT &ev, const int i1, const int i2, const int i3, const int i4,
...
namespace LAMMPS_NS {
template class DihedralOPLSKokkos<Device>;
template class DihedralOPLSKokkos<Host>;
}
