...
PairStyle(tersoff/kk,PairTersoffKokkos<Device>)
PairStyle(tersoff/kk/device,PairTersoffKokkos<Device>)
PairStyle(tersoff/kk/host,PairTersoffKokkos<Host>)
...
class PairTersoffKokkos : public PairTersoff {
 ...
 protected:
  ...
  friend void pair_virial_fdotr_compute<Space,PairTersoffKokkos>(PairTersoffKokkos*);
};
