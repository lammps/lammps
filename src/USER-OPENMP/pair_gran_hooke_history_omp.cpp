...
PairGranHookeHistoryOMP::PairGranHookeHistoryOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  single_enable = 0;
  no_virial_compute = 1;
  history = 1;
...
PairGranHookeHistoryOMP::~PairGranHookeHistoryOMP()
{
...
template <int EVFLAG> 
void PairGranHookeHistoryOMP::eval()
{
...
void PairGranHookeHistoryOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairGranHookeHistoryOMP::settings(int narg, char **arg)
{
...
void PairGranHookeHistoryOMP::coeff(int narg, char **arg)
{
...
void PairGranHookeHistoryOMP::init_style()
{
  int i;
...
void PairGranHookeHistoryOMP::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairGranHookeHistoryOMP::init_one(int i, int j)
{
  if (!allocated) allocate();
...
void PairGranHookeHistoryOMP::write_restart(FILE *fp)
{
...
void PairGranHookeHistoryOMP::read_restart(FILE *fp)
{
...
void PairGranHookeHistoryOMP::write_restart_settings(FILE *fp)
{
...
void PairGranHookeHistoryOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairGranHookeHistoryOMP::reset_dt()
{
  dt = update->dt;
}
