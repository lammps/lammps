...
PPPMDisp::PPPMDisp(LAMMPS *lmp) : KSpace(lmp),
  ...
  rho1d_6(NULL), rho_coeff_6(NULL), drho1d_6(NULL), drho_coeff_6(NULL), work1(NULL),
   work2(NULL), work1_6(NULL), work2_6(NULL), remap(NULL), remap_6(NULL), cg(NULL), cg_peratom(NULL), cg_6(NULL),
...
void _noopt PPPMDisp::allocate()
{
  ...
  if (function[1]) {
    ...
    fft1_6 = std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > ( new heffte::fft3d< heffte::backend::fftw > (
                              heffte::box3d({nxlo_fft_6, nylo_fft_6, nzlo_fft_6}, {nxhi_fft_6, nyhi_fft_6, nzhi_fft_6}),
                            heffte::box3d({nxlo_fft_6, nylo_fft_6, nzlo_fft_6}, {nxhi_fft_6, nyhi_fft_6, nzhi_fft_6}), world, options ) );

    fft2_6 = std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > ( new heffte::fft3d< heffte::backend::fftw > (
                              heffte::box3d({nxlo_fft_6, nylo_fft_6, nzlo_fft_6}, {nxhi_fft_6, nyhi_fft_6, nzhi_fft_6}),
                              heffte::box3d({nxlo_in_6, nylo_in_6, nzlo_in_6}, {nxhi_in_6, nyhi_in_6, nzhi_in_6}), world, options ) );
...
void PPPMDisp::poisson_ik(FFT_SCALAR* wk1, FFT_SCALAR* wk2,
                           FFT_SCALAR* dfft,  std::unique_ptr< heffte::fft3d<heffte::backend::fftw> >  &ft1, std::unique_ptr< heffte::fft3d<heffte::backend::fftw> >  &ft2,
...

{
  ...
  ft1->forward(reinterpret_cast<std::complex<double>*>(wk1), reinterpret_cast<std::complex<double>*>(wk1),  heffte::scale::none);
  ...
  ft2->backward(reinterpret_cast<std::complex<double>*>(wk2), reinterpret_cast<std::complex<double>*>(wk2),  heffte::scale::none);
...
void PPPMDisp:: poisson_peratom(FFT_SCALAR* wk1, FFT_SCALAR* wk2, std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > &ft2,
...

{
  ...
  if (eflag_global + vflag_global == 0) {
    ...
    fft1_6->forward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
  }
  ...
  //   calculated
    ...
    fft1_6->forward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
    fft1_6->forward(reinterpret_cast<std::complex<double>*>(work2_6), reinterpret_cast<std::complex<double>*>(work2_6),  heffte::scale::none);
  ...
  fft2_6->forward(reinterpret_cast<std::complex<double>*>(work2_6), reinterpret_cast<std::complex<double>*>(work2_6),  heffte::scale::none);
...
int PPPMDisp::timing_3d(int n, double &time3d)
{
  ...
  if (function[1] + function[2] + function[3]) {
    for (int i = 0; i < n; i++) {
      fft1_6->forward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
      fft2_6->backward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
      if (differentiation_flag != 1) {
        fft2_6->backward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
        fft2_6->backward(reinterpret_cast<std::complex<double>*>(work1_6), reinterpret_cast<std::complex<double>*>(work1_6),  heffte::scale::none);
      }
