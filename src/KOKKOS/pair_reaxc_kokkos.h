...
PairStyle(reax/c/kk,PairReaxCKokkos<Device>)
PairStyle(reax/c/kk/device,PairReaxCKokkos<Device>)
PairStyle(reax/c/kk/host,PairReaxCKokkos<Host>)
...
class PairReaxCKokkos : public PairReaxC {
 public:
  ...
  double memory_usage();
  void FindBond(int &);
  void PackBondBuffer(DAT::tdual_float_1d, int &);
 ...
 protected:
  ...
  typename AT::t_float_2d_dl d_BO, d_BO_s, d_BO_pi, d_BO_pi2, d_dBOp;
  typename AT::t_float_2d_dl d_dln_BOp_pix, d_dln_BOp_piy, d_dln_BOp_piz;
  typename AT::t_float_2d_dl d_dln_BOp_pi2x, d_dln_BOp_pi2y, d_dln_BOp_pi2z;
  typename AT::t_float_2d_dl d_C1dbo, d_C2dbo, d_C3dbo;
  typename AT::t_float_2d_dl d_C1dbopi, d_C2dbopi, d_C3dbopi, d_C4dbopi;
  typename AT::t_float_2d_dl d_C1dbopi2, d_C2dbopi2, d_C3dbopi2, d_C4dbopi2;
  typename AT::t_float_2d_dl d_Cdbo, d_Cdbopi, d_Cdbopi2, d_dDeltap_self;

  Kokkos::Experimental::ScatterView<typename AT::t_float_1d::data_type, typename AT::t_float_1d::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_total_bo;
  Kokkos::Experimental::ScatterView<typename AT::t_float_1d::data_type, typename AT::t_float_1d::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_CdDelta;
  ...
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_dDeltap_self;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_Cdbo;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_Cdbopi;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterDuplicated> dup_Cdbopi2;

  Kokkos::Experimental::ScatterView<typename AT::t_float_1d::data_type, typename AT::t_float_1d::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_total_bo;
  Kokkos::Experimental::ScatterView<typename AT::t_float_1d::data_type, typename AT::t_float_1d::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_CdDelta;
  ...
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_dDeltap_self;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_Cdbo;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_Cdbopi;
  Kokkos::Experimental::ScatterView<typename AT::t_float_2d_dl::data_type, typename AT::t_float_2d_dl::array_layout,typename KKDevice<DeviceType>::value,Kokkos::Experimental::ScatterSum,Kokkos::Experimental::ScatterNonDuplicated> ndup_Cdbopi2;
  ...
  typename AT::t_float_2d_dl d_sum_ovun;
  typename AT::t_float_2d_dl d_dBOpx, d_dBOpy, d_dBOpz;
  ...
  friend void pair_virial_fdotr_compute<Space,PairReaxCKokkos>(PairReaxCKokkos*);

  int bocnt,hbcnt,enobondsflag;

  typedef LR_lookup_table_kk<Space> LR_lookup_table_kk_DT;

  typedef Kokkos::DualView<LR_lookup_table_kk_DT**,typename DeviceType::array_layout,DeviceType> tdual_LR_lookup_table_kk_2d;
...
struct PairReaxCKokkosFindBondFunctor  {
  ...
  PairReaxCKokkos<Space> c;
  PairReaxCKokkosFindBondFunctor(PairReaxCKokkos<Space>* c_ptr):c(*c_ptr) {};
...
struct PairReaxCKokkosPackBondBufferFunctor  {
  ...
  typedef int value_type;
  PairReaxCKokkos<Space> c;
  PairReaxCKokkosPackBondBufferFunctor(PairReaxCKokkos<Space>* c_ptr):c(*c_ptr) {};
