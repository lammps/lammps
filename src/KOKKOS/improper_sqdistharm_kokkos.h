...
// clang-format off
ImproperStyle(sqdistharm/kk,ImproperSQDistHarmKokkos<LMPDeviceType>);
ImproperStyle(sqdistharm/kk/device,ImproperSQDistHarmKokkos<LMPDeviceType>);
ImproperStyle(sqdistharm/kk/host,ImproperSQDistHarmKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_SQDISTHARM_KOKKOS_H
#define LMP_IMPROPER_SQDISTHARM_KOKKOS_H
...
struct TagImproperSQDistHarmCompute{};

template<class DeviceType>
class ImproperSQDistHarmKokkos : public ImproperSQDistHarm {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperSQDistHarmKokkos(class LAMMPS *);
  ~ImproperSQDistHarmKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperSQDistHarmCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperSQDistHarmCompute<NEWTON_BOND,EVFLAG>, const int&) const;
