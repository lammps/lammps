...
PairTersoffOMP::PairTersoffOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  single_enable = 0;
  one_coeff = 1;
...
#endif
  {
    int i,j,k,ii,jj,kk,inum,jnum,tid;
...
void PairTersoffOMP::settings(int narg, char **arg)
{
...
void PairTersoffOMP::coeff(int narg, char **arg)
{
  int i,j,n;
...
void PairTersoffOMP::init_style()
{
...
double PairTersoffOMP::init_one(int i, int j)
{
...
void PairTersoffOMP::read_file(char *file)
{
