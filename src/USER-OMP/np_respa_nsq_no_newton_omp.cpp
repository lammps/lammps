...
#include "np_respa_nsq_no_newton_omp.h"
...
NeighPairRespaNsqNoNewtonOmp::NeighPairRespaNsqNoNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairRespaNsqNoNewtonOmp::build(NeighList *list)
{
