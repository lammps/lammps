...
/* ----------------------------------------------------------------------
   ...
   OpenMP parallel version: Axel Kohlmeyer (Temple U)
------------------------------------------------------------------------- */
...
PairLJCharmmCoulLongOMP::PairLJCharmmCoulLongOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  respa_enable = 1;
  ftable = NULL;
  implicit = 0;
...
PairLJCharmmCoulLongOMP::~PairLJCharmmCoulLongOMP()
{
  if (allocated) {
...
void PairLJCharmmCoulLongOMP::eval() 
{
...
/* ---------------------------------------------------------------------- */
 ...
 void PairLJCharmmCoulLongOMP::compute_inner()
{
...
void PairLJCharmmCoulLongOMP::eval_inner()
{
#if defined(_OPENMP)
#pragma omp parallel default(shared)
#endif
...
void PairLJCharmmCoulLongOMP::compute_middle()
{
...
template <int NEWTON_PAIR>
void PairLJCharmmCoulLongOMP::eval_middle()
{
#if defined(_OPENMP)
#pragma omp parallel default(shared)
#endif
...
void PairLJCharmmCoulLongOMP::compute_outer(int eflag, int vflag)
{
  if (eflag || vflag) {
    ev_setup(eflag,vflag);
    ev_setup_thr(eflag,vflag);
...
void PairLJCharmmCoulLongOMP::eval_outer() 
{
#if defined(_OPENMP)
#pragma omp parallel default(shared)
#endif
...
void PairLJCharmmCoulLongOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJCharmmCoulLongOMP::settings(int narg, char **arg)
{
...
void PairLJCharmmCoulLongOMP::coeff(int narg, char **arg)
{
...
void PairLJCharmmCoulLongOMP::init_style()
{
  if (!atom->q_flag)
...
void PairLJCharmmCoulLongOMP::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairLJCharmmCoulLongOMP::init_one(int i, int j)
{
...
void PairLJCharmmCoulLongOMP::init_tables()
{
  int masklo,maskhi;
...
void PairLJCharmmCoulLongOMP::write_restart(FILE *fp)
{
...
void PairLJCharmmCoulLongOMP::read_restart(FILE *fp)
{
...
void PairLJCharmmCoulLongOMP::write_restart_settings(FILE *fp)
{
...
void PairLJCharmmCoulLongOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairLJCharmmCoulLongOMP::free_tables()
{
  memory->sfree(rtable);
...
double PairLJCharmmCoulLongOMP::single(int i, int j, int itype, int jtype,
				    double rsq,
