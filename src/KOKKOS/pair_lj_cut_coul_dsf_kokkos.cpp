...
PairLJCutCoulDSFKokkos<Space>::PairLJCutCoulDSFKokkos(LAMMPS *lmp):PairLJCutCoulDSF(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJCutCoulDSFKokkos<Space>::~PairLJCutCoulDSFKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairLJCutCoulDSFKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJCutCoulDSFKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  ev = pair_compute<Space,PairLJCutCoulDSFKokkos<Space>,void >
...
KK_FLOAT PairLJCutCoulDSFKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJCutCoulDSFKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJCutCoulDSFKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJCutCoulDSFKokkos<Space>::init_one(int i, int j)
{
...
namespace LAMMPS_NS {
template class PairLJCutCoulDSFKokkos<Device>;
template class PairLJCutCoulDSFKokkos<Host>;
}
