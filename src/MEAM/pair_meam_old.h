...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(meam/old,PairMEAMOld);
// clang-format on
#else

#ifndef LMP_PAIR_MEAM_OLD_H
#define LMP_PAIR_MEAM_OLD_H

#include "pair.h"

namespace LAMMPS_NS {

class PairMEAMOld : public Pair {
 public:
  PairMEAMOld(class LAMMPS *);
  ~PairMEAMOld() override;
