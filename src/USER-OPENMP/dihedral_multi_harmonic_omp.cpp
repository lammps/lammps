...
DihedralMultiHarmonicOMP::DihedralMultiHarmonicOMP(LAMMPS *lmp) : DihedralOMP(lmp) {}

/* ---------------------------------------------------------------------- */

DihedralMultiHarmonicOMP::~DihedralMultiHarmonicOMP()
{
  if (allocated) {
...
void DihedralMultiHarmonicOMP::eval()
{
...
void DihedralMultiHarmonicOMP::allocate()
{
  allocated = 1;
...
void DihedralMultiHarmonicOMP::coeff(int which, int narg, char **arg)
{
  if (which > 0) return;
...
void DihedralMultiHarmonicOMP::write_restart(FILE *fp)
{
...
void DihedralMultiHarmonicOMP::read_restart(FILE *fp)
{
  allocate();
...
double DihedralMultiHarmonicOMP::memory_usage()
{
