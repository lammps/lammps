...
// clang-format off
ImproperStyle(distance/kk,ImproperDistanceKokkos<LMPDeviceType>);
ImproperStyle(distance/kk/device,ImproperDistanceKokkos<LMPDeviceType>);
ImproperStyle(distance/kk/host,ImproperDistanceKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_DISTANCE_KOKKOS_H
#define LMP_IMPROPER_DISTANCE_KOKKOS_H
...
struct TagImproperDistanceCompute{};

template<class DeviceType>
class ImproperDistanceKokkos : public ImproperDistance {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperDistanceKokkos(class LAMMPS *);
  ~ImproperDistanceKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperDistanceCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperDistanceCompute<NEWTON_BOND,EVFLAG>, const int&) const;
