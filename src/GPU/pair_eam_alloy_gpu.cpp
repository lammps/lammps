...
PairEAMAlloyGPU::PairEAMAlloyGPU(LAMMPS *lmp) : PairEAMGPU(lmp)
{
  ...
  gpu_init_fn = eam_alloy_gpu_init;
  gpu_clear_fn = eam_alloy_gpu_clear;
  gpu_compute_n_fn = eam_alloy_gpu_compute_n;
  gpu_compute_fn = eam_alloy_gpu_compute;
  gpu_compute_force_fn = eam_alloy_gpu_compute_force;
  gpu_bytes_fn = eam_alloy_gpu_bytes;
}
