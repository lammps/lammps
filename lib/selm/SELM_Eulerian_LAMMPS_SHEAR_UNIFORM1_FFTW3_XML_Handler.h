...
#ifndef SELM_EULERIAN_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_HANDLER_H
#define SELM_EULERIAN_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_HANDLER_H
...
class SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_Handler : public Atz_XML_SAX_DataHandler {

 public:

  /* ======================== Function prototypes ======================= */
  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_Handler();
  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_Handler(SELM_Eulerian_Delegator_XML_Handler *delegatorHandler);

  virtual ~SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_XML_Handler();
  ...
  string         xmlTagName_flagWriteFluidVel_VTK;
  string         xmlTagName_flagWriteFluidForce_VTK;
  string         xmlTagName_flagWriteFluidPressure_VTK;

  friend class SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3;

  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3 *eulerian; /* object to construct */
