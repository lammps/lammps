...
This improper style is the equivalent of the GROMACS dihedral type 4,
the `periodic improper dihedral <https://manual.gromacs.org/documentation/current/reference-manual/functions/bonded-interactions.html#improper-dihedrals-periodic-type>`_.
...
angle, the formula for this improper style similar to 
