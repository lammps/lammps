/*
 ...
 SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler.cpp
...
#include "SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler.h"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler() {

  setupDataHandler();

}

SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler(SELM_Eulerian_Delegator_XML_Handler *delegatorHandler) {

  typedef  SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3::SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType;

  setupDataHandler();

  /* allocate the eulerian object and the parameters data structure */
  eulerian = new SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3();

  eulerian->SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_Params
    = (SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType *)
    malloc(sizeof(SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType));
    
  // initialize to zero  
  memset(eulerian->SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_Params,
         0,sizeof(SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType));    
  //eulerian->SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_Params->flagUseFluidPressure = 0; // init       
...
void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::setupDataHandler() {

  DataHandlerName                         = "Default Data Handler";
  DataHandlerType                         = "SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler";
...
void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_startDocument(Atz_XML_SAX_DataHandler* sourceHandler) {

}

void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_endDocument(Atz_XML_SAX_DataHandler* sourceHandler) {

}

void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_startElement(string qName, Atz_XML::AttributesType *attributes, Atz_XML_SAX_DataHandler* sourceHandler) {
...
void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_characters(string xmlString_in, Atz_XML_SAX_DataHandler* sourceHandler) {
  xmlString += xmlString_in;
}

void SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_endElement(string qName, Atz_XML_SAX_DataHandler* sourceHandler) {

  SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3::SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_ParamsType *eulerianData;

  if (eulerian != NULL) {
    eulerianData = eulerian->SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_Params;
  }
...
void *SELM_Eulerian_FLUID_SHEAR_UNIFORM1_FFTW3_XML_Handler::XML_getData() { /* gets data from parsing the XML */
  return eulerian;
}
