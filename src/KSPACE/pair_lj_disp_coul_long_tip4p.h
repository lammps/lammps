...
PairStyle(lj/disp/coul/long/tip4p,PairLJDispCoulLongTIP4P)

#else

#ifndef LMP_PAIR_LJ_DISP_COUL_LONG_TIP4P_H
#define LMP_PAIR_LJ_DISP_COUL_LONG_TIP4P_H

#include "pair_lj_disp_coul_long.h"

namespace LAMMPS_NS {

class PairLJDispCoulLongTIP4P : public PairLJDispCoulLong {
 public:
  PairLJDispCoulLongTIP4P(class LAMMPS *);
  ~PairLJDispCoulLongTIP4P();
