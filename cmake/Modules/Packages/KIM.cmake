...
if(CURL_FOUND)
  ...
  message(STATUS "PKG_KIM: CURL library not found.")
  message(STATUS "PKG_KIM: Building without libcurl; Use of the 'kim_query' command will result in an error.")
endif()
find_package(PkgConfig QUIET)
set(DOWNLOAD_KIM_DEFAULT ON)
if(PKG_CONFIG_FOUND)
  pkg_check_modules(KIM-API QUIET libkim-api>=${KIM-API_CUR_VERSION})
  if(KIM-API_FOUND)
...
if(DOWNLOAD_KIM)
  message(STATUS "PKG_KIM: KIM-API download requested - we will build our own")
  ...
  if(KIM-API_FOUND AND KIM_API_VERSION VERSION_GREATER_EQUAL 2.2.0)
    # For kim-api >= 2.2.0
    find_package(KIM-API ${KIM-API_CUR_VERSION} CONFIG REQUIRED)
    ...
    pkg_check_modules(KIM-API REQUIRED IMPORTED_TARGET libkim-api>=${KIM-API_CUR_VERSION})
