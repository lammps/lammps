...
PairNMSplit::PairNMSplit(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
}
...
void PairNMSplit::compute(int eflag, int vflag)
{
...
void PairNMSplit::settings(int narg, char **arg)
{
...
void PairNMSplit::coeff(int narg, char **arg)
{
  if (narg < 6 || narg > 7)
...
double PairNMSplit::init_one(int i, int j)
{
...
void PairNMSplit::write_restart(FILE *fp)
{
...
void PairNMSplit::read_restart(FILE *fp)
{
...
void PairNMSplit::write_restart_settings(FILE *fp)
{
...
void PairNMSplit::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairNMSplit::write_data(FILE *fp)
{
...
void PairNMSplit::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairNMSplit::single(int /*i*/, int /*j*/, int itype, int jtype,
...
void *PairNMSplit::extract(const char *str, int &dim)
{
  dim = 2;
