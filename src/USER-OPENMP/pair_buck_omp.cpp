...
PairBuckOMP::PairBuckOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairBuckOMP::~PairBuckOMP()
{
  if (allocated) {
...
#pragma omp parallel default(shared)
#endif
  {
	...
	if (rsq < cutsq[itype][jtype]) {
	  ...
	  forcelj = buck1[itype][jtype]*r*rexp - buck2[itype][jtype]*r6inv;
...
void PairBuckOMP::settings(int narg, char **arg)
{
...
void PairBuckOMP::coeff(int narg, char **arg)
{
...
double PairBuckOMP::init_one(int i, int j)
{
...
void PairBuckOMP::write_restart(FILE *fp)
{
...
void PairBuckOMP::read_restart(FILE *fp)
{
...
void PairBuckOMP::write_restart_settings(FILE *fp)
{
...
void PairBuckOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairBuckOMP::single(int i, int j, int itype, int jtype,
