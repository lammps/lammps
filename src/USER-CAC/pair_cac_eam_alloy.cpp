...
PairCACEAMAlloy::PairCACEAMAlloy(LAMMPS *lmp) : PairCACEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairCACEAMAlloy::coeff(int narg, char **arg)
{
  int i,j;
...
void PairCACEAMAlloy::read_file(char *filename)
{
  Setfl *file = setfl;
...
void PairCACEAMAlloy::file2array()
{
  int i,j,m,n;
