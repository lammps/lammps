...
/* ----------------------------------------------------------------------
   Contributing authors: Roy Pollock (LLNL), Paul Crozier (SNL), Axel Kohlmeyer (Temple U)
------------------------------------------------------------------------- */
...
double PPPMCG::diffpr(double hx, double hy, double hz, double q2, double **acons)
{
...
double PPPMCG::gf_denom(double x, double y, double z)
{
  double sx,sy,sz;
  sz = sy = sx = 0.0;
...
void PPPMCG::poisson(int eflag, int vflag)
{
  int i,j,k,n;
  double eng;
...
void PPPMCG::procs2grid2d(int nprocs, int nx, int ny, int *px, int *py)
{
...
void PPPMCG::timing(int n, double &time3d, double &time1d)
{
  double time1,time2;
