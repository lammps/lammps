...
PairColloidOMP::PairColloidOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairColloidOMP::~PairColloidOMP()
{
  if (allocated) {
...
void PairColloidOMP::settings(int narg, char **arg)
{
...
void PairColloidOMP::coeff(int narg, char **arg)
{
...
double PairColloidOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairColloidOMP::write_restart(FILE *fp)
{
...
void PairColloidOMP::read_restart(FILE *fp)
{
...
void PairColloidOMP::write_restart_settings(FILE *fp)
{
...
void PairColloidOMP::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairColloidOMP::single(int i, int j, int itype, int jtype, double rsq,
