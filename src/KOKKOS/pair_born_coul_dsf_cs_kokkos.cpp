...
#include "pair_born_coul_dsf_cs_kokkos.h"
...
PairBornCoulDSFCSKokkos<DeviceType>::PairBornCoulDSFCSKokkos(LAMMPS *lmp)
  : PairBornCoulDSFCS(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairBornCoulDSFCSKokkos<DeviceType>::~PairBornCoulDSFCSKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairBornCoulDSFCSKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
...
KK_FLOAT PairBornCoulDSFCSKokkos<DeviceType>::
...
template<class DeviceType>
void PairBornCoulDSFCSKokkos<DeviceType>::allocate()
{
  PairBornCoulDSFCS::allocate();
  ...
  k_params = Kokkos::DualView<params_born_wolf**,Kokkos::LayoutRight,DeviceType>(
    "PairBornCoulDSFCS::params",n+1,n+1);
...
template<class DeviceType>
void PairBornCoulDSFCSKokkos<DeviceType>::init_style()
{
  PairBornCoulDSFCS::init_style();
...
template<class DeviceType>
double PairBornCoulDSFCSKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairBornCoulDSFCS::init_one(i,j);
