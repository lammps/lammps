...
double PPPM::final_accuracy()
{
  ...
  df_rspace = 2.0 * q2_over_sqrt * exp(-g_ewald*g_ewald*cutoff*cutoff);
...
/* ----------------------------------------------------------------------
   Compute qopt for the ik differentiation scheme
------------------------------------------------------------------------- */

double PPPM::compute_qopt_ik()
{
  double qopt = 0.0;
  int i,j,k,l,m,n;
  double *prd;
...
/* ----------------------------------------------------------------------
   Compute qopt for the ad differentiation scheme
------------------------------------------------------------------------- */

double PPPM::compute_qopt_ad()
{
  double qopt = 0.0;
  int i,j,k,l,m,n;
  double *prd;
