...
PairStyle(cac/eam/alloy,PairCACEAMAlloy)

#else

#ifndef LMP_PAIR_CAC_EAM_ALLOY_H
#define LMP_PAIR_CAC_EAM_ALLOY_H
...
class PairCACEAMAlloy : virtual public PairCACEAM {
 public:
  PairCACEAMAlloy(class LAMMPS *);
  virtual ~PairCACEAMAlloy() {}
  void coeff(int, char **);
