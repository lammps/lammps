...
#include "pair_lj_class2_coul_long_cs_kokkos.h"
...
PairLJClass2CoulLongCSKokkos<DeviceType>::PairLJClass2CoulLongCSKokkos(LAMMPS *lmp):PairLJClass2CoulLongCS(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairLJClass2CoulLongCSKokkos<DeviceType>::~PairLJClass2CoulLongCSKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairLJClass2CoulLongCSKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if (ncoultablebits)
    ev = pair_compute<PairLJClass2CoulLongCSKokkos<DeviceType>,CoulLongTable<1> >
      (this,(NeighListKokkos<DeviceType>*)list);
  else
    ev = pair_compute<PairLJClass2CoulLongCSKokkos<DeviceType>,CoulLongTable<0> >
      (this,(NeighListKokkos<DeviceType>*)list);
...
KK_FLOAT PairLJClass2CoulLongCSKokkos<DeviceType>::
compute_fpair(const KK_FLOAT &rsq_in, const int &, const int &,
...
template<class DeviceType>
void PairLJClass2CoulLongCSKokkos<DeviceType>::allocate()
{
  PairLJClass2CoulLongCS::allocate();
  ...
  k_params = Kokkos::DualView<params_lj_coul**,Kokkos::LayoutRight,DeviceType>("PairLJClass2CoulLongCS::params",n+1,n+1);
  params = k_params.template view<DeviceType>();
}

template<class DeviceType>
void PairLJClass2CoulLongCSKokkos<DeviceType>::init_tables(double cut_coul, double *cut_respa)
{
...
template<class DeviceType>
void PairLJClass2CoulLongCSKokkos<DeviceType>::init_style()
{
  PairLJClass2CoulLongCS::init_style();
...
template<class DeviceType>
double PairLJClass2CoulLongCSKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairLJClass2CoulLongCS::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJClass2CoulLongCSKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class PairLJClass2CoulLongCSKokkos<LMPHostType>;
#endif
}
