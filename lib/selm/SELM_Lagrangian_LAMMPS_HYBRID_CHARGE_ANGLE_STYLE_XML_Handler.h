/*
  ...
  SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_Handler.h
  
  http://atzberger.org/
 
*/

#ifndef SELM_LAGRANGIAN_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_HANDLER_H_
#define SELM_LAGRANGIAN_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_HANDLER_H_
...
class SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_Handler : public Atz_XML_SAX_DataHandler {

 public:

  /* ======================== Function prototypes ======================= */
  SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_Handler();
  SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_Handler(SELM_Lagrangian_Delegator_XML_Handler *delegatorHandler);

  virtual ~SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_Handler();
  ...
  string         xmlTagName_flagMobile;

  friend class SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE;

  SELM_Lagrangian_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE *lagrangian; /* object to construct */
...
#endif /* SELM_LAGRANGIAN_LAMMPS_HYBRID_CHARGE_ANGLE_STYLE_XML_HANDLER_H_ */
