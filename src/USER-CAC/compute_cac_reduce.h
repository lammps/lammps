...
ComputeStyle(cac/reduce,ComputeCACReduce)

#else

#ifndef LMP_COMPUTE_CAC_REDUCE_H
#define LMP_COMPUTE_CAC_REDUCE_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeCACReduce : public Compute {
 public:
  ComputeCACReduce(class LAMMPS *, int, char **);
  virtual ~ComputeCACReduce();
  void init();
