...
#include "pair_nm_cut_coul_long_kokkos.h"
...
PairNMCutCoulLongKokkos<DeviceType>::PairNMCutCoulLongKokkos(LAMMPS *lmp)
  : PairNMCutCoulLong(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairNMCutCoulLongKokkos<DeviceType>::~PairNMCutCoulLongKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairNMCutCoulLongKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
...
KK_FLOAT PairNMCutCoulLongKokkos<DeviceType>::
              ...
              const int& itype, const int& jtype) const
{
  ...
  const KK_FLOAT r0n_val = (STACKPARAMS?m_params[itype][jtype].r0n:params(itype,jtype).r0n);
  const KK_FLOAT r0m_val = (STACKPARAMS?m_params[itype][jtype].r0m:params(itype,jtype).r0m);
  ...
  const KK_FLOAT forcenm = e0nm_val * nm_val *
    (r0n_val * rninv - r0m_val * rminv);
  return forcenm * r2inv;
}

/* ----------------------------------------------------------------------
   Ewald long-range Coulomb force (polynomial erfc approximation)
------------------------------------------------------------------------- */
               ...
               const int& itype, const int& jtype) const
{
  ...
  return e0nm_val * (mm_val * r0n_val * rninv - nn_val * r0m_val * rminv) - offset_val;
}

/* ----------------------------------------------------------------------
   Ewald long-range Coulomb potential energy
------------------------------------------------------------------------- */
...
template<class DeviceType>
void PairNMCutCoulLongKokkos<DeviceType>::allocate()
{
  PairNMCutCoulLong::allocate();
...
template<class DeviceType>
void PairNMCutCoulLongKokkos<DeviceType>::init_style()
{
  PairNMCutCoulLong::init_style();
...
template<class DeviceType>
double PairNMCutCoulLongKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairNMCutCoulLong::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairNMCutCoulLongKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class PairNMCutCoulLongKokkos<LMPHostType>;
#endif
}
