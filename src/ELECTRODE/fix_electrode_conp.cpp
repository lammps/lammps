...
FixElectrodeConp::FixElectrodeConp(LAMMPS *lmp, int narg, char **arg) :
    ...
    elyt_vector(nullptr), elec_vector(nullptr), capacitance(nullptr), elastance(nullptr),
    pair(nullptr), mat_neighlist(nullptr), vec_neighlist(nullptr), recvcounts(nullptr),
    displs(nullptr), iele_gathered(nullptr), buf_gathered(nullptr), potential_i(nullptr),
    potential_iele(nullptr)
{
  ...
  MPI_Bcast(&write_vec, 1, MPI_INT, 0, world);
