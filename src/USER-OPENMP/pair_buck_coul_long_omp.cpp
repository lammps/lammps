...
PairBuckCoulLongOMP::PairBuckCoulLongOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairBuckCoulLongOMP::~PairBuckCoulLongOMP()
{
  if (allocated) {
...
void PairBuckCoulLongOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBuckCoulLongOMP::settings(int narg, char **arg)
{
...
void PairBuckCoulLongOMP::coeff(int narg, char **arg)
{
...
double PairBuckCoulLongOMP::init_one(int i, int j)
{
...
void PairBuckCoulLongOMP::init_style()
{
  if (!atom->q_flag)
...
void PairBuckCoulLongOMP::write_restart(FILE *fp)
{
...
void PairBuckCoulLongOMP::read_restart(FILE *fp)
{
...
void PairBuckCoulLongOMP::write_restart_settings(FILE *fp)
{
...
void PairBuckCoulLongOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairBuckCoulLongOMP::single(int i, int j, int itype, int jtype,
				double rsq,
