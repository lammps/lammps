...
PairTersoffKokkos<Space>::PairTersoffKokkos(LAMMPS *lmp) : PairTersoff(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairTersoffKokkos<Space>::~PairTersoffKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairTersoffKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairTersoffKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
void PairTersoffKokkos<Space>::setup_params()
{
...
template<ExecutionSpace Space>
void PairTersoffKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
...
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeShortNeigh, const int& ii) const {
...
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeHalf<NEIGHFLAG,EVFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int NEIGHFLAG, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeHalf<NEIGHFLAG,EVFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
template<int NEIGHFLAG, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeFullA<NEIGHFLAG,EVFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int NEIGHFLAG, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeFullA<NEIGHFLAG,EVFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
template<int NEIGHFLAG, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeFullB<NEIGHFLAG,EVFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int NEIGHFLAG, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::operator()(TagPairTersoffComputeFullB<NEIGHFLAG,EVFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_fc_k(const int &i, const int &j,
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_dfc(const int &i, const int &j,
                const int &k, const KK_FLOAT &r) const
{
  const KK_FLOAT ters_R = paramskk(i,j,k).bigr;
  const KK_FLOAT ters_D = paramskk(i,j,k).bigd;
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::bondorder(const int &i, const int &j, const int &k,
        ...
        const KK_FLOAT &rik, const KK_FLOAT &dx2, const KK_FLOAT &dy2, const KK_FLOAT &dz2) const
{
  ...
  const KK_FLOAT param = paramskk(i,j,k).lam3 * (rij-rik);
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_fa_k(const int &i, const int &j,
                const int &k, const KK_FLOAT &r) const
{
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_dfa(const int &i, const int &j,
                const int &k, const KK_FLOAT &r) const
{
  if (r > paramskk(i,j,k).bigr + paramskk(i,j,k).bigd) return 0.0;
  return paramskk(i,j,k).bigb * exp(-paramskk(i,j,k).lam2 * r) *
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_bij_k(const int &i, const int &j,
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
KK_FLOAT PairTersoffKokkos<Space>::ters_dbij(const int &i, const int &j,
                const int &k, const KK_FLOAT &bo) const
{
  const KK_FLOAT tmp = paramskk(i,j,k).beta * bo;
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::ters_dthb(
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::ters_dthbj(
        const int &i, const int &j, const int &k, const KK_FLOAT &prefactor,
        const KK_FLOAT &rij, const KK_FLOAT &dx1, const KK_FLOAT &dy1, const KK_FLOAT &dz1,
        const KK_FLOAT &rik, const KK_FLOAT &dx2, const KK_FLOAT &dy2, const KK_FLOAT &dz2,
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::ters_dthbk(
        const int &i, const int &j, const int &k, const KK_FLOAT &prefactor,
        const KK_FLOAT &rij, const KK_FLOAT &dx1, const KK_FLOAT &dy1, const KK_FLOAT &dz1,
        const KK_FLOAT &rik, const KK_FLOAT &dx2, const KK_FLOAT &dy2, const KK_FLOAT &dz2,
        KK_FLOAT *fk) const
...
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::ev_tally(EV_FLOAT &ev, const int &i, const int &j,
...
template<int NEIGHFLAG>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::v_tally3(EV_FLOAT &ev, const int &i, const int &j, const int &k,
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairTersoffKokkos<Space>::v_tally3_atom(EV_FLOAT &ev, const int &i, const int &j, const int &k,
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
int PairTersoffKokkos<Space>::sbmask(const int& j) const {
  return j >> SBBITS & 3;
}

namespace LAMMPS_NS {
template class PairTersoffKokkos<Device>;
template class PairTersoffKokkos<Host>;
}
