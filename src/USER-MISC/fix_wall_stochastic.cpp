...
{  
  ...
  //RanMars *random;
  if (strcmp(arg[3],"diffusive") == 0)  {reflectionstyle = DIFFUSIVE; arginc = 6;}
  else if (strcmp(arg[3],"maxwell") == 0)  {reflectionstyle = MAXWELL; arginc = 7;}
  else if (strcmp(arg[3],"cercignanilampis") == 0)  {reflectionstyle = CERCIGNANILAMPIS; arginc = 9;}
