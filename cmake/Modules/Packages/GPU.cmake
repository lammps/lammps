...
file(GLOB GPU_LIB_SOURCES ${LAMMPS_CONFIGURE_DEPENDS} ${LAMMPS_LIB_SOURCE_DIR}/gpu/[^.]*.cpp)
...
if(GPU_API STREQUAL "CUDA")
  ...
  file(GLOB GPU_LIB_CU ${LAMMPS_CONFIGURE_DEPENDS} ${LAMMPS_LIB_SOURCE_DIR}/gpu/[^.]*.cu ${CMAKE_CURRENT_SOURCE_DIR}/gpu/[^.]*.cu)
  ...
  if(CUDPP_OPT)
    ...
    file(GLOB GPU_LIB_CUDPP_SOURCES ${LAMMPS_CONFIGURE_DEPENDS} ${LAMMPS_LIB_SOURCE_DIR}/gpu/cudpp_mini/[^.]*.cpp)
    file(GLOB GPU_LIB_CUDPP_CU ${LAMMPS_CONFIGURE_DEPENDS} ${LAMMPS_LIB_SOURCE_DIR}/gpu/cudpp_mini/[^.]*.cu)
  endif()
...
elseif(GPU_API STREQUAL "OPENCL")
  ...
  file(GLOB GPU_LIB_CU ${LAMMPS_CONFIGURE_DEPENDS} ${LAMMPS_LIB_SOURCE_DIR}/gpu/[^.]*.cu)
