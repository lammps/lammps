...
PairLJ96CutOMP::PairLJ96CutOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  respa_enable = 1;
}
...
void PairLJ96CutOMP::compute_inner()
{
...
void PairLJ96CutOMP::eval_inner()
{
...
void PairLJ96CutOMP::compute_middle()
{
...
template <int NEWTON_PAIR>
void PairLJ96CutOMP::eval_middle()
{
#if defined(_OPENMP)
#pragma omp parallel default(shared)
#endif
...
void PairLJ96CutOMP::compute_outer(int eflag, int vflag)
{
  if (eflag || vflag) {
    ev_setup(eflag,vflag);
    ev_setup_thr(eflag,vflag);
...
void PairLJ96CutOMP::eval_outer()
{
#if defined(_OPENMP)
#pragma omp parallel default(shared)
#endif
...
void PairLJ96CutOMP::settings(int narg, char **arg)
{
...
void PairLJ96CutOMP::coeff(int narg, char **arg)
{
...
void PairLJ96CutOMP::init_style()
{
...
void PairLJ96CutOMP::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairLJ96CutOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJ96CutOMP::write_restart(FILE *fp)
{
...
void PairLJ96CutOMP::read_restart(FILE *fp)
{
...
void PairLJ96CutOMP::write_restart_settings(FILE *fp)
{
...
void PairLJ96CutOMP::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairLJ96CutOMP::single(int i, int j, int itype, int jtype, double rsq,
