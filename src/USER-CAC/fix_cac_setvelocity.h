...
E: Region ID for fix cac/setvelocity does not exist

Self-explanatory.

E: Variable name for fix cac/setvelocity does not exist
...
E: Variable for fix cac/setvelocity is invalid style
