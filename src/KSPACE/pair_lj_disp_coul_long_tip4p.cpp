...
#include "stdlib.h"
#include "string.h"
#include "pair_lj_disp_coul_long_tip4p.h"
#include "angle.h"
#include "atom.h"
#include "bond.h"
#include "comm.h"
...
PairLJDispCoulLongTIP4P::PairLJDispCoulLongTIP4P(LAMMPS *lmp) : 
  PairLJDispCoulLong(lmp)
{
  single_enable = 0;
  respa_enable = 0;
...
PairLJDispCoulLongTIP4P::~PairLJDispCoulLongTIP4P()
{
...
void PairLJDispCoulLongTIP4P::compute(int eflag, int vflag)
{
...
void PairLJDispCoulLongTIP4P::settings(int narg, char **arg)
{
...
void PairLJDispCoulLongTIP4P::init_style()
{
...
double PairLJDispCoulLongTIP4P::init_one(int i, int j)
{
  double cut = PairLJDispCoulLong::init_one(i,j);
...
void PairLJDispCoulLongTIP4P::write_restart_settings(FILE *fp)
{
...
void PairLJDispCoulLongTIP4P::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairLJDispCoulLongTIP4P::compute_newsite(double *xO, double *xH1,
...
void *PairLJDispCoulLongTIP4P::extract(const char *str, int &dim)
{
  dim = 0;
...
double PairLJDispCoulLongTIP4P::memory_usage()
{
