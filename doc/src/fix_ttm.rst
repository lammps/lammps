...
.. code-block:: LAMMPS
   ...
   fix fix-ID group-ID ttm seed C_e rho_e kappa_e gamma_p gamma_s v_0 Nx Ny Nz keyword value ...
   fix fix-ID group-ID ttm/mod seed init_file Nx Ny Nz keyword value ...
   fix fix-ID group-ID ttm/thermal seed properties_file Nx Ny Nz keyword value ...
