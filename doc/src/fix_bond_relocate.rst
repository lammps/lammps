.. index:: fix bond/relocate

fix bond/relocate command
=====================
...
.. parsed-literal::
   ...
   fix ID group-ID bond/relocate Nevery relocateBondType decidingBondType lowcutoff hicutoff fraction seed decidingFunctionality

* ID, group-ID are documented in :doc:`fix <fix>` command
* bond/relocate = style name of this fix command
* Nevery = attempt bond swapping every this many steps
* relocateBondType = the bond type to do relocation for/with
* decidingBondType = the bond type to use to decide whether to consider relocation,
* lowcutoff = min distance at which the new bond will be considered (distance units)
...
.. code-block:: LAMMPS
   ...
   fix 1 all bond/relocate 50 0.5 1.3 598934 1 2 1
