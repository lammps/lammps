...
TEST_F(AtomStyleTest, body_nparticle)
{
    ...
    ASSERT_DOUBLE_EQ(bonus[0].inertia[0], 2.0);
    ASSERT_DOUBLE_EQ(bonus[0].inertia[1], 2.0);
    ASSERT_DOUBLE_EQ(bonus[0].inertia[2], 0.0);
    ASSERT_DOUBLE_EQ(bonus[1].inertia[0], 0.5);
    ASSERT_DOUBLE_EQ(bonus[1].inertia[1], 4.0);
    ASSERT_DOUBLE_EQ(bonus[1].inertia[2], 4.5);
    ASSERT_DOUBLE_EQ(bonus[2].inertia[0], 1.67188);
    ASSERT_DOUBLE_EQ(bonus[2].inertia[1], 1.7746273249544022);
    ASSERT_DOUBLE_EQ(bonus[2].inertia[2], 0.49099767504559777);
    ASSERT_DOUBLE_EQ(bonus[3].inertia[0], 12.0);
    ASSERT_DOUBLE_EQ(bonus[3].inertia[1], 0.0);
    ASSERT_DOUBLE_EQ(bonus[3].inertia[2], 12.0);
    ASSERT_DOUBLE_EQ(bonus[0].quat[0], 1.0);
    ASSERT_DOUBLE_EQ(bonus[0].quat[1], 0.0);
    ASSERT_DOUBLE_EQ(bonus[0].quat[2], 0.0);
    ASSERT_DOUBLE_EQ(bonus[0].quat[3], 0.0);
    ...
    EXPECT_DOUBLE_EQ(angmom[GETIDX(1)][0], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(1)][1], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(1)][2], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(2)][0], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(2)][1], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(2)][2], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(3)][0], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(3)][1], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(3)][2], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(4)][0], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(4)][1], 0.0);
    EXPECT_DOUBLE_EQ(angmom[GETIDX(4)][2], 0.0);
    ...
    EXPECT_DOUBLE_EQ(bonus[1].inertia[0], 4.5);
    EXPECT_DOUBLE_EQ(bonus[1].inertia[1], 4.0);
    EXPECT_DOUBLE_EQ(bonus[1].inertia[2], 0.5);
    ...
    EXPECT_DOUBLE_EQ(bonus[3].inertia[1], 12.0);
    EXPECT_DOUBLE_EQ(bonus[3].inertia[2], 0.0);
    ...
    EXPECT_DOUBLE_EQ(bonus[1].quat[0], 1.0);
    ...
    EXPECT_DOUBLE_EQ(bonus[3].quat[0], 0.94328772332207422);
    EXPECT_DOUBLE_EQ(bonus[3].quat[1], -0.19726148412050853);
    EXPECT_DOUBLE_EQ(bonus[3].quat[2], -0.075803071317030998);
    EXPECT_DOUBLE_EQ(bonus[3].quat[3], 0.25056280708573148);
    EXPECT_EQ(bonus[0].ilocal, 0);
    EXPECT_EQ(bonus[1].ilocal, 1);
    EXPECT_EQ(bonus[2].ilocal, 2);
    EXPECT_EQ(bonus[3].ilocal, 3);
    EXPECT_EQ(bonus[0].ninteger, 1);
    EXPECT_EQ(bonus[1].ninteger, 1);
    EXPECT_EQ(bonus[2].ninteger, 1);
    EXPECT_EQ(bonus[3].ninteger, 1);
    EXPECT_EQ(bonus[0].ndouble, 6);
    EXPECT_EQ(bonus[1].ndouble, 9);
    EXPECT_EQ(bonus[2].ndouble, 12);
    EXPECT_EQ(bonus[3].ndouble, 6);
    EXPECT_NE(bonus[0].ivalue, nullptr);
    EXPECT_NE(bonus[0].ivalue, nullptr);
    EXPECT_NE(bonus[1].ivalue, nullptr);
    EXPECT_NE(bonus[2].ivalue, nullptr);
    EXPECT_NE(bonus[3].ivalue, nullptr);
    EXPECT_EQ(bonus[0].ivalue[0], 2);
    EXPECT_EQ(bonus[1].ivalue[0], 3);
    EXPECT_EQ(bonus[2].ivalue[0], 4);
    EXPECT_EQ(bonus[3].ivalue[0], 2);
    EXPECT_NE(bonus[0].dvalue, nullptr);
    EXPECT_NE(bonus[1].dvalue, nullptr);
    EXPECT_NE(bonus[2].dvalue, nullptr);
