...
#include <string.h>
#include "npair_half_bytype_newton_tri.h"
#include "neighbor.h"
...
NPairHalfBytypeNewtonTri::NPairHalfBytypeNewtonTri(LAMMPS *lmp) : NPair(lmp) {}
...
void NPairHalfBytypeNewtonTri::build(NeighList *list)
{
