...
PairLJGromacsCoulGromacsOMP::PairLJGromacsCoulGromacsOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairLJGromacsCoulGromacsOMP::~PairLJGromacsCoulGromacsOMP()
{
  if (allocated) {
...
void PairLJGromacsCoulGromacsOMP::eval()
{
...
void PairLJGromacsCoulGromacsOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJGromacsCoulGromacsOMP::settings(int narg, char **arg)
{
  if (narg != 2 && narg != 4)
...
void PairLJGromacsCoulGromacsOMP::coeff(int narg, char **arg)
{
...
void PairLJGromacsCoulGromacsOMP::init_style()
{
  if (!atom->q_flag)
...
double PairLJGromacsCoulGromacsOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJGromacsCoulGromacsOMP::write_restart(FILE *fp)
{
...
void PairLJGromacsCoulGromacsOMP::read_restart(FILE *fp)
{
...
void PairLJGromacsCoulGromacsOMP::write_restart_settings(FILE *fp)
{
...
void PairLJGromacsCoulGromacsOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJGromacsCoulGromacsOMP::single(int i, int j, int itype, int jtype,
				double rsq,
