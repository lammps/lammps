...
PairStyle(lj/cut/HAdResS/Coarsegrained,PairLJCutHADRESSCOARSEGRAINED)

#else

#ifndef LMP_PAIR_LJ_CUT_HADRESS_COARSEGRAINED_H
#define LMP_PAIR_LJ_CUT_HADRESS_COARSEGRAINED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutHADRESSCOARSEGRAINED : public Pair {
 public:
  PairLJCutHADRESSCOARSEGRAINED(class LAMMPS *);
  virtual ~PairLJCutHADRESSCOARSEGRAINED();
