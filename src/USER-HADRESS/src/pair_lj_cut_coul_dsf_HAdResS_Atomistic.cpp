...
#include "stdlib.h"
#include "string.h"
#include "pair_lj_cut_coul_dsf_HAdResS_Atomistic.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
#include "neighbor.h"
...
PairLJCutCoulDSFHADRESSATOMISTIC::PairLJCutCoulDSFHADRESSATOMISTIC(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
...
PairLJCutCoulDSFHADRESSATOMISTIC::~PairLJCutCoulDSFHADRESSATOMISTIC()
{
  if (allocated) {
...
void PairLJCutCoulDSFHADRESSATOMISTIC::compute(int eflag, int vflag)
{
...
void PairLJCutCoulDSFHADRESSATOMISTIC::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJCutCoulDSFHADRESSATOMISTIC::settings(int narg, char **arg)
{
...
void PairLJCutCoulDSFHADRESSATOMISTIC::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5) 
...
void PairLJCutCoulDSFHADRESSATOMISTIC::init_style()
{
  if (!atom->q_flag)
...
double PairLJCutCoulDSFHADRESSATOMISTIC::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJCutCoulDSFHADRESSATOMISTIC::write_restart(FILE *fp)
{
...
void PairLJCutCoulDSFHADRESSATOMISTIC::read_restart(FILE *fp)
{
...
void PairLJCutCoulDSFHADRESSATOMISTIC::write_restart_settings(FILE *fp)
{
...
void PairLJCutCoulDSFHADRESSATOMISTIC::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJCutCoulDSFHADRESSATOMISTIC::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairLJCutCoulDSFHADRESSATOMISTIC::extract(const char *str, int &dim)
{
...
int PairLJCutCoulDSFHADRESSATOMISTIC::molecules_in_group(tagint &idlo, tagint &idhi)
{
  int i;
...
void PairLJCutCoulDSFHADRESSATOMISTIC::AT_Print_Compensation_Energy(){
...
void PairLJCutCoulDSFHADRESSATOMISTIC::AT_Update_Compensation_Energy(){
...
void PairLJCutCoulDSFHADRESSATOMISTIC::Load_Compensation_Pressure(){
...
void PairLJCutCoulDSFHADRESSATOMISTIC::H_AdResS_Allocation(){
