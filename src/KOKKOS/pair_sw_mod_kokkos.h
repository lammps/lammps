...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(sw/mod/kk,PairSWMODKokkos<LMPDeviceType>);
PairStyle(sw/mod/kk/device,PairSWMODKokkos<LMPDeviceType>);
PairStyle(sw/mod/kk/host,PairSWMODKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_PAIR_SW_MOD_KOKKOS_H
#define LMP_PAIR_SW_MOD_KOKKOS_H

#include "pair_sw_mod.h"
#include "pair_kokkos.h"

template<int NEIGHFLAG, int EVFLAG>
struct TagPairSWMODCompute{};

struct TagPairSWMODComputeShortNeigh{};

namespace LAMMPS_NS {

template<class DeviceType>
class PairSWMODKokkos : public PairSWMOD {
 public:
  ...
  PairSWMODKokkos(class LAMMPS *);
  ~PairSWMODKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagPairSWMODCompute<NEIGHFLAG,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEIGHFLAG, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagPairSWMODCompute<NEIGHFLAG,EVFLAG>, const int&) const;

// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagPairSWMODComputeShortNeigh, const int&) const;
...
// NOLINTNEXTLINE
  ...
  friend void pair_virial_fdotr_compute<PairSWMODKokkos>(PairSWMODKokkos*);
};
