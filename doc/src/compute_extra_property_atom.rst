...
.. code-block:: LAMMPS
   ...
   compute ID group-ID extraProperty/atom name property_name dim property_dim
...
.. code-block:: LAMMPS
   ...
   compute 1 all extraProperty/atom name force_var_cov dim 9
...
.. code-block:: LAMMPS
   ...
   dump 1 all custom 1 eatoms_std.xyz id c_peAtom c_peStdAtom
