...
NeighBin::NeighBin(LAMMPS *lmp) : Pointers(lmp)
{
...
void NeighBin::copy_neighbor_info()
{
...
void NeighBin::bin_atoms_setup(int nall)
{
...
int NeighBin::coord2bin(double *x)
{
  int ix,iy,iz;
