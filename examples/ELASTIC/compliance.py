...
def compute_compliance_matrix():
    '''The function performing the actual computation of the elastic constants'''

    parser = ArgumentParser(description='A python script to compute the elastic constants')
    parser.add_argument("input_log_file", help="The name of the input log file")
    ...
    # open logfile
    with open(args.input_log_file, 'r') as logfile:
        txt = logfile.read()
    ...
    for i in range(6):
        for j in range(6):
            print("{0:10.8g} ".format(c[i][j]), end=" ")
        print()
    ...
    for i in range(6):
        for j in range(6):
            print("{0:10.8g} ".format(s[i][j]), end=" ")
        print()

if __name__ == "__main__":
    compute_compliance_matrix()
