...
PairLJGromacsCoulGromacsKokkos<Space>::PairLJGromacsCoulGromacsKokkos(LAMMPS *lmp):PairLJGromacsCoulGromacs(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJGromacsCoulGromacsKokkos<Space>::~PairLJGromacsCoulGromacsKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairLJGromacsCoulGromacsKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairLJGromacsCoulGromacsKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJGromacsCoulGromacsKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairLJGromacsCoulGromacsKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJGromacsCoulGromacsKokkos<Space>::init_one(int i, int j)
{
  KK_FLOAT cutone = PairLJGromacsCoulGromacs::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJGromacsCoulGromacsKokkos<Device>;
template class PairLJGromacsCoulGromacsKokkos<Host>;
}
