...
// clang-format off
ImproperStyle(fourier/kk,ImproperFourierKokkos<LMPDeviceType>);
ImproperStyle(fourier/kk/device,ImproperFourierKokkos<LMPDeviceType>);
ImproperStyle(fourier/kk/host,ImproperFourierKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_FOURIER_KOKKOS_H
#define LMP_IMPROPER_FOURIER_KOKKOS_H
...
struct TagImproperFourierCompute{};

template<class DeviceType>
class ImproperFourierKokkos : public ImproperFourier {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperFourierKokkos(class LAMMPS *);
  ~ImproperFourierKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperFourierCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperFourierCompute<NEWTON_BOND,EVFLAG>, const int&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void addone(EV_FLOAT &ev, const int i1, const int i2, const int i3, const int i4,
              const int type,
...
// NOLINTNEXTLINE
 ...
 protected:
  ...
  DAT::tdual_kkfloat_1d k_C0;
  DAT::tdual_kkfloat_1d k_C1;
  DAT::tdual_kkfloat_1d k_C2;
  DAT::tdual_int_1d k_all;

  typename AT::t_kkfloat_1d d_k;
  typename AT::t_kkfloat_1d d_C0;
  typename AT::t_kkfloat_1d d_C1;
  typename AT::t_kkfloat_1d d_C2;
  typename AT::t_int_1d d_all;
