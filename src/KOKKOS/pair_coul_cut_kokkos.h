...
PairStyle(coul/cut/kk,PairCoulCutKokkos<Device>)
PairStyle(coul/cut/kk/device,PairCoulCutKokkos<Device>)
PairStyle(coul/cut/kk/host,PairCoulCutKokkos<Host>)
...
class PairCoulCutKokkos : public PairCoulCut {
 ...
 protected:
  ...
  void allocate();
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,FULL,true>;
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,HALF,true>;
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,HALFTHREAD,true>;
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,FULL,false>;
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,HALF,false>;
  friend class PairComputeFunctor<Space,PairCoulCutKokkos,HALFTHREAD,false>;
  friend EV_FLOAT pair_compute_neighlist<Space,PairCoulCutKokkos,FULL,void>(PairCoulCutKokkos*,NeighListKokkos<Space>*);
  friend EV_FLOAT pair_compute_neighlist<Space,PairCoulCutKokkos,HALF,void>(PairCoulCutKokkos*,NeighListKokkos<Space>*);
  friend EV_FLOAT pair_compute_neighlist<Space,PairCoulCutKokkos,HALFTHREAD,void>(PairCoulCutKokkos*,NeighListKokkos<Space>*);
  friend EV_FLOAT pair_compute<Space,PairCoulCutKokkos,void>(PairCoulCutKokkos*,
                                                       NeighListKokkos<Space>*);
  friend void pair_virial_fdotr_compute<Space,PairCoulCutKokkos>(PairCoulCutKokkos*);
