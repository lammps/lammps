...
#include <string.h>
#include "np_granular_nsq_no_newton.h"
#include "neighbor.h"
...
NeighPairGranularNsqNoNewton::NeighPairGranularNsqNoNewton(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularNsqNoNewton::build(NeighList *list)
{
