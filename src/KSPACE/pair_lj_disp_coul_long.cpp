...
void PairLJDispCoulLong::options(char **arg, int order)
{
...
void PairLJDispCoulLong::settings(int narg, char **arg)
{
...
PairLJDispCoulLong::~PairLJDispCoulLong()
{
  if (allocated) {
...
void PairLJDispCoulLong::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void *PairLJDispCoulLong::extract(const char *id, int &dim)
{
  const char *ids[] = {
...
void PairLJDispCoulLong::coeff(int narg, char **arg)
{
...
void PairLJDispCoulLong::init_style()
{
  const char *style1[] = 
...
void PairLJDispCoulLong::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairLJDispCoulLong::init_one(int i, int j)
{
...
void PairLJDispCoulLong::write_restart(FILE *fp)
{
...
void PairLJDispCoulLong::read_restart(FILE *fp)
{
...
void PairLJDispCoulLong::write_restart_settings(FILE *fp)
{
...
void PairLJDispCoulLong::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairLJDispCoulLong::compute(int eflag, int vflag)
{
...
void PairLJDispCoulLong::compute_inner()
{
...
void PairLJDispCoulLong::compute_middle()
{
  double rsq, r2inv, force_coul = 0.0, force_lj, fpair;
...
void PairLJDispCoulLong::compute_outer(int eflag, int vflag)
{
  double evdwl,ecoul,fpair;
  evdwl = ecoul = 0.0;
  if (eflag || vflag) ev_setup(eflag,vflag);
...
void PairLJDispCoulLong::init_tables()
{
  int masklo,maskhi;
...
void PairLJDispCoulLong::free_tables()
{
...
double PairLJDispCoulLong::single(int i, int j, int itype, int jtype,
