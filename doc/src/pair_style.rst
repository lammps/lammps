...
* :doc:`hbond/dreiding/lj/angleoffset <pair_hbond_dreiding_angleoffset>` - DREIDING hydrogen bonding LJ potential with offset for hbond angle
* :doc:`hbond/dreiding/morse <pair_hbond_dreiding>` - DREIDING hydrogen bonding Morse potential
* :doc:`hbond/dreiding/morse/angleoffset <pair_hbond_dreiding_angleoffset>` - DREIDING hydrogen bonding Morse potential with offset for hbond angle
