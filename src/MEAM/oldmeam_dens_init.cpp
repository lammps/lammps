...
void MEAMOld::meam_dens_setup(int atom_nmax, int nall, int n_neigh)
{
  int i, j;
...
void MEAMOld::meam_dens_init(int i, int ntype, int *type, int *fmap, double **x, int numneigh,
...
void MEAMOld::getscreen(int i, double *scrfcn, double *dscrfcn, double *fcpair, double **x,
...
void MEAMOld::calc_rho1(int i, int /*ntype*/, int *type, int *fmap, double **x, int numneigh,
