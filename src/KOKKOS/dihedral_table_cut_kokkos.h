...
// clang-format off
DihedralStyle(table/cut/kk,DihedralTableCutKokkos<LMPDeviceType>);
DihedralStyle(table/cut/kk/device,DihedralTableCutKokkos<LMPDeviceType>);
DihedralStyle(table/cut/kk/host,DihedralTableCutKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_DIHEDRAL_TABLE_CUT_KOKKOS_H
#define LMP_DIHEDRAL_TABLE_CUT_KOKKOS_H
...
struct TagDihedralTableCutCompute{};

template<class DeviceType>
class DihedralTableCutKokkos : public DihedralTableCut {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  DihedralTableCutKokkos(class LAMMPS *);
  ~DihedralTableCutKokkos() override;
...
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagDihedralTableCutCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagDihedralTableCutCompute<NEWTON_BOND,EVFLAG>, const int&) const;
