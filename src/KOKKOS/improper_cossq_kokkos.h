...
// clang-format off
ImproperStyle(cossq/kk,ImproperCossqKokkos<LMPDeviceType>);
ImproperStyle(cossq/kk/device,ImproperCossqKokkos<LMPDeviceType>);
ImproperStyle(cossq/kk/host,ImproperCossqKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_COSSQ_KOKKOS_H
#define LMP_IMPROPER_COSSQ_KOKKOS_H
...
struct TagImproperCossqCompute{};

template<class DeviceType>
class ImproperCossqKokkos : public ImproperCossq {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperCossqKokkos(class LAMMPS *);
  ~ImproperCossqKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperCossqCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperCossqCompute<NEWTON_BOND,EVFLAG>, const int&) const;
