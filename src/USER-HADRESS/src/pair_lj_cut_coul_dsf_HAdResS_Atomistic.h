...
PairStyle(lj/cut/coul/dsf/HAdResS/Atomistic,PairLJCutCoulDSFHADRESSATOMISTIC)

#else

#ifndef LMP_PAIR_LJ_CUT_COUL_DSF_HADRESS_ATOMISTIC_H
#define LMP_PAIR_LJ_CUT_COUL_DSF_HADRESS_ATOMISTIC_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutCoulDSFHADRESSATOMISTIC : public Pair {
 public:
  PairLJCutCoulDSFHADRESSATOMISTIC(class LAMMPS *);
  ~PairLJCutCoulDSFHADRESSATOMISTIC();
