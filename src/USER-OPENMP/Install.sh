...
if (test $1 = 1) then
  ...
  if (test -e ../dihedral_harmonic.cpp); then
    cp dihedral_charmm_omp.h ..
    cp dihedral_charmm_omp.cpp ..
  ...
  if (test -e ../pair_gran_hooke_history.cpp) then
    ...
    cp pair_gran_hooke_omp.cpp ..
    cp pair_gran_hooke_history_omp.h ..
    cp pair_gran_hooke_history_omp.cpp ..
  fi
  ...
  if (test -e ../pair_lj_charmm_coul_long.cpp) then
    ...
    cp pair_lj_cut_coul_long_tip4p_omp.h ..
    cp pair_lj_cut_coul_long_tip4p_omp.cpp ..
    cp ewald_omp.h ..
    cp ewald_omp.cpp ..
  fi
  ...
  if (test -e ../pair_lj_class2.cpp) then
	...
	cp pair_lj_class2_coul_long_omp.cpp ..
	cp pair_lj_class2_coul_long_omp.h ..
    cp dihedral_class2_omp.cpp ..
    cp dihedral_class2_omp.h ..
  fi
  ...
  rm -f ../pair_gran_hooke_omp.cpp
  rm -f ../pair_gran_hooke_history_omp.h
  rm -f ../pair_gran_hooke_history_omp.cpp
  ...
  rm -f ../pair_lj_cut_coul_long_tip4p_omp.h
  rm -f ../pair_lj_cut_coul_long_tip4p_omp.cpp
  rm -f ../ewald_omp.h
  rm -f ../ewald_omp.cpp
