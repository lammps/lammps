...
#ifdef USE_OPENCL
#include "crml_gpu_cl2.h"
#else
#include "crml_gpu_ptx2.h"
#endif

#include "crml_gpu_memory2.h"
#include <cassert>
#define CRML_GPU_Memory2T CRML_GPU_Memory2<numtyp, acctyp>

extern PairGPUDevice<PRECISION,ACC_PRECISION> pair_gpu_device;

template <class numtyp, class acctyp>
CRML_GPU_Memory2T::CRML_GPU_Memory2() : ChargeGPUMemory2<numtyp,acctyp>(),
                                    _allocated(false) {
}

template <class numtyp, class acctyp>
CRML_GPU_Memory2T::~CRML_GPU_Memory2() {
  clear();
}
 
template <class numtyp, class acctyp>
int CRML_GPU_Memory2T::bytes_per_atom(const int max_nbors) const {
  return this->bytes_per_atom_atomic(max_nbors);
}

template <class numtyp, class acctyp>
int CRML_GPU_Memory2T::init(const int ntypes,
...
template <class numtyp, class acctyp>
double CRML_GPU_Memory2T::host_memory_usage() const {
  return this->host_memory_usage_atomic()+sizeof(CRML_GPU_Memory2<numtyp,acctyp>);
}
...
template class CRML_GPU_Memory2<PRECISION,ACC_PRECISION>;
