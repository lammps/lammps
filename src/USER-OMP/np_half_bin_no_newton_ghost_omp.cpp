...
#include "np_half_bin_no_newton_ghost_omp.h"
...
NeighPairHalfBinNoNewtonGhostOmp::NeighPairHalfBinNoNewtonGhostOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairHalfBinNoNewtonGhostOmp::build(NeighList *list)
{
