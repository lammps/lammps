...
PairLJSmoothOMP::PairLJSmoothOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairLJSmoothOMP::~PairLJSmoothOMP()
{
  if (allocated) {
...
void PairLJSmoothOMP::settings(int narg, char **arg)
{
...
void PairLJSmoothOMP::coeff(int narg, char **arg)
{
  if (narg != 4 && narg != 6)
...
double PairLJSmoothOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJSmoothOMP::write_restart(FILE *fp)
{
...
void PairLJSmoothOMP::read_restart(FILE *fp)
{
...
void PairLJSmoothOMP::write_restart_settings(FILE *fp)
{
...
void PairLJSmoothOMP::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairLJSmoothOMP::single(int i, int j, int itype, int jtype, double rsq,
