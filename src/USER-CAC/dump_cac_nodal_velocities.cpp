...
DumpCACNodalVelocities::DumpCACNodalVelocities(LAMMPS *lmp, int narg, char **arg) : Dump(lmp, narg, arg)
{
...
DumpCACNodalVelocities::~DumpCACNodalVelocities()
{
...
void DumpCACNodalVelocities::init_style()
{
  ...
  if (buffer_flag == 1) write_choice = &DumpCACNodalVelocities::write_string;
  else write_choice = &DumpCACNodalVelocities::write_lines;
...
int DumpCACNodalVelocities::modify_param(int narg, char **arg)
{
...
void DumpCACNodalVelocities::write_header(bigint n)
{
...
void DumpCACNodalVelocities::pack(tagint *ids)
{
  int m,n;
...
int DumpCACNodalVelocities::convert_string(int n, double *mybuf)
{
  int offset = 0;
  int m = 0;
  for (int i = 0; i < n; i++) {
...
void DumpCACNodalVelocities::write_data(int n, double *mybuf)
{
...
void DumpCACNodalVelocities::write_string(int n, double *mybuf)
{
...
void DumpCACNodalVelocities::write_lines(int n, double *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
    fprintf(fp,format,
