...
PairLJCharmmCoulLongKokkos<Space>::PairLJCharmmCoulLongKokkos(LAMMPS *lmp):PairLJCharmmCoulLong(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJCharmmCoulLongKokkos<Space>::~PairLJCharmmCoulLongKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulLongKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulLongKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairLJCharmmCoulLongKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairLJCharmmCoulLongKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJCharmmCoulLongKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJCharmmCoulLongKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulLongKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulLongKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJCharmmCoulLongKokkos<Space>::init_one(int i, int j)
{
  KK_FLOAT cutone = PairLJCharmmCoulLong::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJCharmmCoulLongKokkos<Device>;
template class PairLJCharmmCoulLongKokkos<Host>;
}
