...
#include <string.h>
#include "npair_half_size_bytype_newton_tri.h"
...
NPairHalfSizeBytypeNewtonTri::NPairHalfSizeBytypeNewtonTri(LAMMPS *lmp) : NPair(lmp) {}
...
void NPairHalfSizeBytypeNewtonTri::build(NeighList *list)
{
