...
if(DOWNLOAD_KIM)
  ...
  if(NOT BUILD_FORTRAN)
    message(FATAL_ERROR "Building KIM-API from source (DOWNLOAD_KIM=ON) requires Fortran. Install a system KIM-API and set DOWNLOAD_KIM=OFF, or set BUILD_FORTRAN=ON.")
  endif()
