...
template <int EVFLAG> 
void PairGranHertzHistoryOMP::eval()
{
...
#pragma omp parallel default(shared)
#endif
  {
	...
	if (rsq >= radsum*radsum) {
	  ...
	  if (EVFLAG) ev_tally_xyz_thr(i,j,nlocal,0,0.0,0.0,
...
void PairGranHertzHistoryOMP::settings(int narg, char **arg)
{
