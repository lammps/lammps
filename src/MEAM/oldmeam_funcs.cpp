...
//
double MEAMOld::G_gam(const double gamma, const int ibar, int &errorflag) const
{
...
//  -5 => G = +-sqrt(abs(1+gamma))
//
double MEAMOld::dG_gam(const double gamma, const int ibar, double &dG) const
{
  double gsmooth_switchpoint;
  double G;
...
//
double MEAMOld::zbl(const double r, const int z1, const int z2)
{
  int i;
...
//
double MEAMOld::embedding(const double A, const double Ec, const double rhobar, double &dF) const
{
...
//
double MEAMOld::erose(const double r, const double re, const double alpha, const double Ec,
...
//
void MEAMOld::get_shpfcn(const lattice_t latt, const double sthe, const double cthe, double (&s)[3])
{
  switch (latt) {
    case FCC:
    case BCC:
...
//
int MEAMOld::get_Zij(const lattice_t latt)
{
  switch (latt) {
    case FCC:
      return 12;
...
//
int MEAMOld::get_Zij2(const lattice_t latt, const double cmin, const double cmax, const double stheta,
                   double &a, double &S)
{
...
int MEAMOld::get_Zij2_b2nn(const lattice_t latt, const double cmin, const double cmax, double &S)
{
