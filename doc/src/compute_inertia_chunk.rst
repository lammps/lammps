...
.. versionchanged:: TBD
   ...
   superellipsoids, line segments, triangles, and body particles) the moment
   of inertia of the particle's own shape is now added to each chunk via the
   parallel-axis theorem.  Previously all atoms were treated as point masses.
   For finite spheres, ellipsoids, lines, and triangles this matches the
   :doc:`fix rigid <fix_rigid>` command; superellipsoids and body particles
   use their stored per-particle moment of inertia.
