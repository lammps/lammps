...
void MEAMOld::meam_setup_done(double* cutmax)
{
  int nv2, nv3, m, n, p;
...
void MEAMOld::compute_pair_meam()
{
  double r;
  int j, a, b, nv2;
...
//
double MEAMOld::phi_meam(double r, int a, int b)
{
...
//
double MEAMOld::phi_meam_series(const double scrn, const int Z1, const int Z2, const int a, const int b,
...
void MEAMOld::compute_reference_density()
{
...
void MEAMOld::get_tavref(double* t11av, double* t21av, double* t31av, double* t12av, double* t22av, double* t32av,
...
//------------------------------------------------------------------------------c
void MEAMOld::get_sijk(double C, int i, int j, int k, double* sijk)
{
  double x;
...
void MEAMOld::get_densref(double r, int a, int b, double* rho01, double* rho11, double* rho21, double* rho31,
...
void MEAMOld::interpolate_meam(int ind)
{
  int j;
  double drar;
