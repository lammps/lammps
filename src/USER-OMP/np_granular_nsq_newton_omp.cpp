...
#include <string.h>
#include "np_granular_nsq_newton_omp.h"
...
NeighPairGranularNsqNewtonOmp::NeighPairGranularNsqNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularNsqNewtonOmp::build(NeighList *list)
{
