...
PairLJClass2Kokkos<Space>::PairLJClass2Kokkos(LAMMPS *lmp) : PairLJClass2(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJClass2Kokkos<Space>::~PairLJClass2Kokkos()
{
  if (allocated) {
...
template<ExecutionSpace Space>
void PairLJClass2Kokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJClass2Kokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev = pair_compute<Space,PairLJClass2Kokkos<Space>,void >(this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJClass2Kokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJClass2Kokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJClass2Kokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairLJClass2Kokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJClass2Kokkos<Space>::init_one(int i, int j)
{
...
namespace LAMMPS_NS {
template class PairLJClass2Kokkos<Device>;
template class PairLJClass2Kokkos<Host>;
}
