...
#include "np_half_bin_no_newton_ghost.h"
#include "neighbor.h"
...
NeighPairHalfBinNoNewtonGhost::NeighPairHalfBinNoNewtonGhost(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairHalfBinNoNewtonGhost::build(NeighList *list)
{
