...
#include "pair_lj_cut_coul_long_soft_kokkos.h"
...
PairLJCutCoulLongSoftKokkos<DeviceType>::PairLJCutCoulLongSoftKokkos(LAMMPS *lmp):PairLJCutCoulLongSoft(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairLJCutCoulLongSoftKokkos<DeviceType>::~PairLJCutCoulLongSoftKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairLJCutCoulLongSoftKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev = pair_compute<PairLJCutCoulLongSoftKokkos<DeviceType>,void >
...
KK_FLOAT PairLJCutCoulLongSoftKokkos<DeviceType>::
...
template<class DeviceType>
void PairLJCutCoulLongSoftKokkos<DeviceType>::allocate()
{
  PairLJCutCoulLongSoft::allocate();
  ...
  k_params = Kokkos::DualView<params_lj_coul_soft**,Kokkos::LayoutRight,DeviceType>("PairLJCutCoulLongSoft::params",n+1,n+1);
...
template<class DeviceType>
void PairLJCutCoulLongSoftKokkos<DeviceType>::init_style()
{
...
template<class DeviceType>
double PairLJCutCoulLongSoftKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairLJCutCoulLongSoft::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJCutCoulLongSoftKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class PairLJCutCoulLongSoftKokkos<LMPHostType>;
#endif
}
