...
#ifndef LMP_ONE_MOLECULE2_H
#define LMP_ONE_MOLECULE2_H

#include "pointers.h"

namespace LAMMPS_NS {

class Molecule2 : protected Pointers {
 public:
  ...
  double **lines;      // line corner points
  ...
  Molecule2(class LAMMPS *, int, char **, int &);
  ~Molecule2() override;
  void compute_center();
  void compute_mass();
  void compute_com();
