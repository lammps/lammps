...
#include "np_half_nsq_no_newton_ghost.h"
#include "neighbor.h"
...
NeighPairHalfNsqNoNewtonGhost::NeighPairHalfNsqNoNewtonGhost(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairHalfNsqNoNewtonGhost::build(NeighList *list)
{
