...
PairStyle(eam/alloy/kk,PairEAMAlloyKokkos<Device>)
PairStyle(eam/alloy/kk/device,PairEAMAlloyKokkos<Device>)
PairStyle(eam/alloy/kk/host,PairEAMAlloyKokkos<Host>)
...
class PairEAMAlloyKokkos : public PairEAM, public KokkosBase {
 ...
 protected:
  ...
  friend void pair_virial_fdotr_compute<Space,PairEAMAlloyKokkos>(PairEAMAlloyKokkos*);
};
