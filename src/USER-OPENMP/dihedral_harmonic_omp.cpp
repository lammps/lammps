...
DihedralHarmonicOMP::DihedralHarmonicOMP(LAMMPS *lmp) : DihedralOMP(lmp) {}

/* ---------------------------------------------------------------------- */

DihedralHarmonicOMP::~DihedralHarmonicOMP()
{
  if (allocated) {
...
void DihedralHarmonicOMP::allocate()
{
  allocated = 1;
...
void DihedralHarmonicOMP::write_restart(FILE *fp)
{
...
void DihedralHarmonicOMP::read_restart(FILE *fp)
{
  allocate();
...
double DihedralHarmonicOMP::memory_usage()
{
