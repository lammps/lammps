...
PairYukawaOMP::PairYukawaOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairYukawaOMP::~PairYukawaOMP()
{
  if (allocated) {
...
void PairYukawaOMP::settings(int narg, char **arg)
{
...
void PairYukawaOMP::coeff(int narg, char **arg)
{
...
double PairYukawaOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairYukawaOMP::write_restart(FILE *fp)
{
...
void PairYukawaOMP::read_restart(FILE *fp)
{
...
void PairYukawaOMP::write_restart_settings(FILE *fp)
{
...
void PairYukawaOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairYukawaOMP::single(int i, int j, int itype, int jtype, double rsq,
