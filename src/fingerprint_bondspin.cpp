...
Fingerprint_bondspin::Fingerprint_bondspin(PairRANN *pair) : Fingerprint(pair)
{
	n_body_type = 3;
	dr = 0;
	re = 0;
...
bool Fingerprint_bondspin::parse_values(char * constant, char * line1){
...
void Fingerprint_bondspin::init(int *i,int id){
...
int Fingerprint_bondspin::factorial(int n) {
   if ((n==0)||(n==1))
      return 1;
   else
