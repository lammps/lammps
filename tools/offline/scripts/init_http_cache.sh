...
PACELIB_URL="https://github.com/ICAMS/lammps-user-pace/archive/refs/tags/v.2021.10.25.yaml_pace.upd2.tar.gz"
...
PACELIB_FILENAME="v.2021.10.25.yaml_pace.upd2.tar.gz"
