...
#include "stdlib.h"
#include "atom_vec_full_HAdResS.h"
#include "atom.h"
#include "comm.h"
#include "domain.h"
#include "modify.h"
...
AtomVecFullHadress::AtomVecFullHadress(LAMMPS *lmp) : AtomVec(lmp)
{
  molecular = 1;
...
void AtomVecFullHadress::grow(int n)
{
  if (n == 0) grow_nmax();
  else nmax = n;
  atom->nmax = nmax;
...
void AtomVecFullHadress::grow_reset()
{
...
void AtomVecFullHadress::copy(int i, int j, int delflag)
{
  int k;
...
int AtomVecFullHadress::pack_comm(int n, int *list, double *buf,
...
int AtomVecFullHadress::pack_comm_vel(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecFullHadress::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFullHadress::unpack_comm_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFullHadress::pack_reverse(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFullHadress::unpack_reverse(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecFullHadress::pack_border(int n, int *list, double *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecFullHadress::pack_border_vel(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecFullHadress::pack_border_hybrid(int n, int *list, double *buf)
{
  int i,j,m;
...
void AtomVecFullHadress::unpack_border(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFullHadress::unpack_border_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFullHadress::unpack_border_hybrid(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFullHadress::pack_exchange(int i, double *buf)
{
  int k;
...
int AtomVecFullHadress::unpack_exchange(double *buf)
{
  int k;
...
int AtomVecFullHadress::size_restart()
{
  int i;
...
int AtomVecFullHadress::pack_restart(int i, double *buf)
{
  int k;
...
int AtomVecFullHadress::unpack_restart(double *buf)
{
  int k;
...
void AtomVecFullHadress::create_atom(int itype, double *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecFullHadress::data_atom(double *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
int AtomVecFullHadress::data_atom_hybrid(int nlocal, char **values)
{
...
void AtomVecFullHadress::pack_data(double **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecFullHadress::pack_data_hybrid(int i, double *buf)
{
...
void AtomVecFullHadress::write_data(FILE *fp, int n, double **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecFullHadress::write_data_hybrid(FILE *fp, double *buf)
{
...
bigint AtomVecFullHadress::memory_usage()
{
  bigint bytes = 0;
