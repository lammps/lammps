...
FixStyle(nph/kk,FixNPHKokkos<Device>)
FixStyle(nph/kk/device,FixNPHKokkos<Device>)
FixStyle(nph/kk/host,FixNPHKokkos<Host>)
...
class FixNPHKokkos : public FixNHKokkos<Space> {
 public:
