...
PairEAMFSKokkos<Space>::PairEAMFSKokkos(LAMMPS *lmp) : PairEAM(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairEAMFSKokkos<Space>::~PairEAMFSKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::file2array()
{
  file2array_fs();
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::array2spline()
{
  rdr = 1.0/dr;
  rdrho = 1.0/drho;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::interpolate(int n, KK_FLOAT delta, double *f, t_host_float_2d_n7 h_spline, int i)
{
...
template<ExecutionSpace Space>
int PairEAMFSKokkos<Space>::pack_forward_comm_kokkos(int n, DAT::tdual_int_2d k_sendlist, int iswap_in, DAT::tdual_float_1d &buf,
...
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSPackForwardComm, const int &i) const {
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::unpack_forward_comm_kokkos(int n, int first_in, DAT::tdual_float_1d &buf)
{
  first = first_in;
  v_buf = DualViewHelper<Space>::view(buf);
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSUnpackForwardComm, const int &i) const {
...
template<ExecutionSpace Space>
int PairEAMFSKokkos<Space>::pack_forward_comm(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
  int i,j;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::unpack_forward_comm(int n, int first, double *buf)
{
  for (int i = 0; i < n; i++) {
    h_fp[i + first] = buf[i];
  }
...
template<ExecutionSpace Space>
int PairEAMFSKokkos<Space>::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
template<ExecutionSpace Space>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSInitialize, const int &i) const {
  d_rho[i] = 0.0;
}
...
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelA<NEIGHFLAG,NEWTON_PAIR>, const int &ii) const {
...
template<int EFLAG>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelB<EFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int EFLAG>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelB<EFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
template<int EFLAG>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelAB<EFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int EFLAG>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelAB<EFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelC<NEIGHFLAG,NEWTON_PAIR,EVFLAG>, const int &ii, EV_FLOAT& ev) const {
...
template<int NEIGHFLAG, int NEWTON_PAIR, int EVFLAG>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::operator()(TagPairEAMFSKernelC<NEIGHFLAG,NEWTON_PAIR,EVFLAG>, const int &ii) const {
  EV_FLOAT ev;
...
template<int NEIGHFLAG, int NEWTON_PAIR>
KOKKOS_INLINE_FUNCTION
void PairEAMFSKokkos<Space>::ev_tally(EV_FLOAT &ev, const int &i, const int &j,
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::coeff(int narg, char **arg)
{
  int i,j;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::read_file(char *filename)
{
  Fs *file = fs;
...
template<ExecutionSpace Space>
void PairEAMFSKokkos<Space>::file2array_fs()
{
  int i,j,m,n;
...
namespace LAMMPS_NS {
template class PairEAMFSKokkos<Device>;
template class PairEAMFSKokkos<Host>;
}
