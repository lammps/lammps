...
#include <string.h>
#include "np_granular_nsq_no_newton_omp.h"
...
NeighPairGranularNsqNoNewtonOmp::NeighPairGranularNsqNoNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularNsqNoNewtonOmp::build(NeighList *list)
{
