...
PairLJExpandOMP::PairLJExpandOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairLJExpandOMP::~PairLJExpandOMP()
{
  if (allocated) {
...
void PairLJExpandOMP::settings(int narg, char **arg)
{
...
void PairLJExpandOMP::coeff(int narg, char **arg)
{
...
double PairLJExpandOMP::init_one(int i, int j)
{
...
void PairLJExpandOMP::write_restart(FILE *fp)
{
...
void PairLJExpandOMP::read_restart(FILE *fp)
{
...
void PairLJExpandOMP::write_restart_settings(FILE *fp)
{
...
void PairLJExpandOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJExpandOMP::single(int i, int j, int itype, int jtype, double rsq,
