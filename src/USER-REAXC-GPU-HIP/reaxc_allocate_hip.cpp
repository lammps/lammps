                        ...
                        char * /*msg*/ )
{
  ...
  /* GMRES storage */
  workspace->y = (double*) scalloc(control->error_ptr,  RESTART_REAX+1, sizeof(double), "y");
  workspace->z = (double*) scalloc(control->error_ptr,  RESTART_REAX+1, sizeof(double), "z");
  workspace->g = (double*) scalloc(control->error_ptr,  RESTART_REAX+1, sizeof(double), "g");
  workspace->h = (double*) scalloc(control->error_ptr,  (RESTART_REAX+1)*(RESTART_REAX+1), sizeof(double), "h");
  workspace->hs = (double*) scalloc(control->error_ptr,  RESTART_REAX+1, sizeof(double), "hs");
  workspace->hc = (double*) scalloc(control->error_ptr,  RESTART_REAX+1, sizeof(double), "hc");
  workspace->v = (double*) scalloc(control->error_ptr,  (RESTART_REAX+1)*(RESTART_REAX+1), sizeof(double), "v");
