...
PairLJCutCoulCutOMP::PairLJCutCoulCutOMP(LAMMPS *lmp) : PairOMP(lmp) {}

/* ---------------------------------------------------------------------- */

PairLJCutCoulCutOMP::~PairLJCutCoulCutOMP()
{
  if (allocated) {
...
void PairLJCutCoulCutOMP::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJCutCoulCutOMP::settings(int narg, char **arg)
{
...
void PairLJCutCoulCutOMP::coeff(int narg, char **arg)
{
...
void PairLJCutCoulCutOMP::init_style()
{
  if (!atom->q_flag)
...
double PairLJCutCoulCutOMP::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJCutCoulCutOMP::write_restart(FILE *fp)
{
...
void PairLJCutCoulCutOMP::read_restart(FILE *fp)
{
...
void PairLJCutCoulCutOMP::write_restart_settings(FILE *fp)
{
...
void PairLJCutCoulCutOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLJCutCoulCutOMP::single(int i, int j, int itype, int jtype,
				double rsq,
