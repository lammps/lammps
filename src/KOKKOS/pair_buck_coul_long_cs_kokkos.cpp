...
#include "pair_buck_coul_long_cs_kokkos.h"
...
PairBuckCoulLongCSKokkos<DeviceType>::PairBuckCoulLongCSKokkos(LAMMPS *lmp):PairBuckCoulLongCS(lmp)
{
  respa_enable = 0;
...
template<class DeviceType>
PairBuckCoulLongCSKokkos<DeviceType>::~PairBuckCoulLongCSKokkos()
{
  if (copymode) return;
...
template<class DeviceType>
void PairBuckCoulLongCSKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if (ncoultablebits)
    ev = pair_compute<PairBuckCoulLongCSKokkos<DeviceType>,CoulLongTable<1> >
      (this,(NeighListKokkos<DeviceType>*)list);
  else
    ev = pair_compute<PairBuckCoulLongCSKokkos<DeviceType>,CoulLongTable<0> >
      (this,(NeighListKokkos<DeviceType>*)list);
...
template<class DeviceType>
void PairBuckCoulLongCSKokkos<DeviceType>::allocate()
{
  PairBuckCoulLongCS::allocate();
  ...
  k_params = Kokkos::DualView<params_buck_coul**,Kokkos::LayoutRight,DeviceType>("PairBuckCoulLongCS::params",n+1,n+1);
  params = k_params.template view<DeviceType>();
}

template<class DeviceType>
void PairBuckCoulLongCSKokkos<DeviceType>::init_tables(double cut_coul, double *cut_respa)
{
...
template<class DeviceType>
void PairBuckCoulLongCSKokkos<DeviceType>::init_style()
{
  PairBuckCoulLongCS::init_style();
...
template<class DeviceType>
double PairBuckCoulLongCSKokkos<DeviceType>::init_one(int i, int j)
{
  double cutone = PairBuckCoulLongCS::init_one(i,j);
