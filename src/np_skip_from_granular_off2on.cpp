...
#include <string.h>
#include "np_skip_from_granular_off2on.h"
#include "neighbor.h"
...
NeighPairSkipFromGranularOff2on::NeighPairSkipFromGranularOff2on(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairSkipFromGranularOff2on::build(NeighList *list)
{
