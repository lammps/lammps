...
bool FixPourOpt::outside(int dim, double value, double lo, double hi)
{
...
void FixPourOpt::xyz_random(double h, double *coord)
{
  if (domain->dimension == 3) {
    if (region_style == 1) {
...
double FixPourOpt::radius_sample()
{
...
void FixPourOpt::options(int narg, char **arg)
{
  // defaults
...
void *FixPourOpt::extract(const char *str, int &itype)
{
