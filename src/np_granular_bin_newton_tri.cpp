...
#include <string.h>
#include "np_granular_bin_newton_tri.h"
#include "neighbor.h"
...
NeighPairGranularBinNewtonTri::NeighPairGranularBinNewtonTri(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularBinNewtonTri::build(NeighList *list)
{
