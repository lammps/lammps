...
Description:
Style "fene/nm" is based on the standard bond style "fene" which consists of two components: 1) an attractive logarithmic term and 2) a repulsive Lennard-Joines (n=12-m=6) term. 
