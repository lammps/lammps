...
Atom::~Atom()
{
  ...
  memory->destroy(q);
  memory->destroy(q_change);
  memory->destroy(q_Interval);
                             ...
                             int ilocal, tagint offset)
{
 ...
 // if (onemol->qflag && q_flag) q_change[ilocal] = onemol->q_change[iatom];
...
void *Atom::extract(char *name)
{
  ...
  if (strcmp(name,"q_change") == 0) return (void *) q_change;
  if (strcmp(name,"q_Interval") == 0) return (void *) q_Interval;
  ...
  if (strcmp(name,"moltypeH") == 0) return (void *) moltypeH;
  if (strcmp(name,"comH") == 0) return (void *) comH;
