...
PairStyle(lj/sf/kk,PairLJSmoothLinearKokkos<LMPDeviceType>);
PairStyle(lj/sf/kk/device,PairLJSmoothLinearKokkos<LMPDeviceType>);
PairStyle(lj/sf/kk/host,PairLJSmoothLinearKokkos<LMPHostType>);
// clang-format on
#else
...
// NOLINTNEXTLINE
    ...
    params_lj() {cutsq=0;cut=0;lj1=0;lj2=0;lj3=0;lj4=0;ljcut=0;dljcut=0;};
// NOLINTNEXTLINE
    KOKKOS_INLINE_FUNCTION
    params_lj(int /*i*/) {cutsq=0;cut=0;lj1=0;lj2=0;lj3=0;lj4=0;ljcut=0;dljcut=0;};
    KK_FLOAT cutsq,cut,lj1,lj2,lj3,lj4,ljcut,dljcut;
  };
