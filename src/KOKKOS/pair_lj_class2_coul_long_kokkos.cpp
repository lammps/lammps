...
PairLJClass2CoulLongKokkos<Space>::PairLJClass2CoulLongKokkos(LAMMPS *lmp):PairLJClass2CoulLong(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJClass2CoulLongKokkos<Space>::~PairLJClass2CoulLongKokkos()
{
  if (!copymode){
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairLJClass2CoulLongKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairLJClass2CoulLongKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJClass2CoulLongKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairLJClass2CoulLongKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJClass2CoulLongKokkos<Space>::init_one(int i, int j)
{
  KK_FLOAT cutone = PairLJClass2CoulLong::init_one(i,j);
...
namespace LAMMPS_NS {
template class PairLJClass2CoulLongKokkos<Device>;
template class PairLJClass2CoulLongKokkos<Host>;
}
