...
PairMombOMP::PairMombOMP(LAMMPS *lmp) : PairMomb(lmp), ThrOMP(lmp, THR_PAIR)
{
...
void PairMombOMP::compute(int eflag, int vflag)
{
  ev_init(eflag, vflag);
...
void PairMombOMP::eval(int iifrom, int iito, ThrData *const thr)
{
...
double PairMombOMP::memory_usage()
{
  double bytes = memory_usage_thr();
  bytes += PairMomb::memory_usage();
  return bytes;
}
