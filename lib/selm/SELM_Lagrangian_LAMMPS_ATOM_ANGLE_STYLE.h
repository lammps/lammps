...
#ifndef SELM_LAGRANGIAN_LAMMPS_ATOM_ANGLE_STYLE_H
#define SELM_LAGRANGIAN_LAMMPS_ATOM_ANGLE_STYLE_H
...
class SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE : public SELM_Lagrangian {
 ...
 public:
  ...
  SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE(int, char **);
  SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE(class LAMMPS *lmps, class DriverSELM *fx);
  ...
  typedef struct SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE_ParamsType {
  ...
  } SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE_ParamsType;
  ...
  SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE_ParamsType *SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE_Params;
