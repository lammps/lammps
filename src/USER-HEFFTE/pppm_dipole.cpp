...
void PPPMDipole::allocate()
{
  ...
  fft1 = std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > ( new heffte::fft3d< heffte::backend::fftw > (
  ...
  fft2 = std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > ( new heffte::fft3d< heffte::backend::fftw > (
                          heffte::box3d({nxlo_fft, nylo_fft, nzlo_fft}, {nxhi_fft, nyhi_fft, nzhi_fft}),
