...
double PairSpinNeel::compute_neel_energy(int i, int j, double rsq, double eij[3],
    double spi[3], double spj[3])
{
  ...
  energy = gij*(si_sj*ri3 - eij_si*eij_sj);
  energy -= q1ij*(eij_si*eij_si - si_sj*ri3)*(eij_sj*eij_sj - si_sj*ri3);
  energy -= q2ij*eij_sj*eij_si*(eij_si*eij_si + eij_sj*eij_sj);
