...
void PairBornCoulWolfKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  ...
  if (eflag) {
    ...
    Kokkos::parallel_reduce(Kokkos::RangePolicy<DeviceType,TagPairBornCoulWolfSelfEnergy>(0,list->inum),
                            *this,e_self_sum);
...
// NOLINTNEXTLINE
KOKKOS_INLINE_FUNCTION
void PairBornCoulWolfKokkos<DeviceType>::operator()(TagPairBornCoulWolfSelfEnergy,
