...
#ifdef FIX_CLASS
// clang-format off
FixStyle(wall/lj126/kk,FixWallLJ126Kokkos<LMPDeviceType>);
FixStyle(wall/lj126/kk/device,FixWallLJ126Kokkos<LMPDeviceType>);
FixStyle(wall/lj126/kk/host,FixWallLJ126Kokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_FIX_WALL_LJ126_KOKKOS_H
#define LMP_FIX_WALL_LJ126_KOKKOS_H
...
class FixWallLJ126Kokkos : public FixWallLJ126 {
 public:
  ...
  FixWallLJ126Kokkos(class LAMMPS *, int, char **);
  ~FixWallLJ126Kokkos() override;
