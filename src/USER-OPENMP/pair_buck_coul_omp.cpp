...
PairBuckCoulOMP::PairBuckCoulOMP(LAMMPS *lmp) : PairOMP(lmp)
{
  respa_enable = 1;
  ftable = NULL;
}
...
void PairBuckCoulOMP::options(char **arg, int order)
{
...
void PairBuckCoulOMP::settings(int narg, char **arg)
{
...
PairBuckCoulOMP::~PairBuckCoulOMP()
{
  if (allocated) {
...
void *PairBuckCoulOMP::extract(char *id)
{
  char *ids[] = {
...
void PairBuckCoulOMP::coeff(int narg, char **arg)
{
...
void PairBuckCoulOMP::init_style()
{
...
void PairBuckCoulOMP::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairBuckCoulOMP::init_one(int i, int j)
{
...
void PairBuckCoulOMP::write_restart(FILE *fp)
{
...
void PairBuckCoulOMP::read_restart(FILE *fp)
{
...
void PairBuckCoulOMP::write_restart_settings(FILE *fp)
{
...
void PairBuckCoulOMP::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairBuckCoulOMP::init_tables()
{
  int masklo,maskhi;
...
void PairBuckCoulOMP::free_tables()
{
  memory->sfree(rtable);
...
double PairBuckCoulOMP::single(int i, int j, int itype, int jtype,
