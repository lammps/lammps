...
// DEM verification test 13: spinning sphere damped by twisting friction (sds and marshall).
// All test logic is shared via test_dem_common; the reference systems
// live in tests/dem13-*.yaml.
