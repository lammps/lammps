...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(table/mod,PairTableMod);
// clang-format on
#else

#ifndef LMP_PAIR_TABLE_MOD_H
#define LMP_PAIR_TABLE_MOD_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableMod : public Pair {
 public:
  PairTableMod(class LAMMPS *);
  ~PairTableMod() override;
