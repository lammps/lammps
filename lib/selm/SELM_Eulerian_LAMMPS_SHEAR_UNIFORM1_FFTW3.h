...
#ifndef SELM_EULERIAN_LAMMPS_SHEAR_UNIFORM1_FFTW3_H
#define SELM_EULERIAN_LAMMPS_SHEAR_UNIFORM1_FFTW3_H
...
class SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3 : public SELM_Eulerian {
 ...
 public:
  ...
  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3(int, char **);
  ...
  void userAppl_write3VecFieldVTUFile(const char   *filename,
                                      int     num_dim,
                                      int    *numMeshPtsPerDir,
                                      double *meshCenterX0,
                                      double *meshLengths,
  ...
  typedef struct SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_ParamsType {
    ...
    /* value may be over-ridden by integrator */
    double                      shearRate;
    int                         shearDir;
    int                         shearVelDir;
    double                      shearDist;
  ...
  typedef struct SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_ExtrasType {
  ...
  /* ======================== Variables ======================== */
  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_ParamsType *SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_Params;
  SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_ExtrasType *SELM_Eulerian_LAMMPS_SHEAR_UNIFORM1_FFTW3_Extras;
