...
#include "np_half_nsq_no_newton_ghost_omp.h"
...
NeighPairHalfNsqNoNewtonGhostOmp::NeighPairHalfNsqNoNewtonGhostOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairHalfNsqNoNewtonGhostOmp::build(NeighList *list)
{
