...
#include <string.h>
#include "np_granular_bin_no_newton_omp.h"
...
NeighPairGranularBinNoNewtonOmp::NeighPairGranularBinNoNewtonOmp(LAMMPS *lmp) : 
  NeighPair(lmp) {}
...
void NeighPairGranularBinNoNewtonOmp::build(NeighList *list)
{
