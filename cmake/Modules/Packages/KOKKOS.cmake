...
if(PKG_KSPACE)
  ...
  set(FFT_KOKKOS_VALUES KISS FFTW3 MKL HIPFFT CUFFT MKL_GPU)
  ...
  elseif(FFT_KOKKOS STREQUAL "MKL_GPU")
    ...
    target_compile_definitions(lammps PRIVATE -DFFT_KOKKOS_MKL_GPU)
  ...
  elseif(FFT_KOKKOS STREQUAL "MKL")
    find_package(MKL REQUIRED)
    target_compile_definitions(lammps PRIVATE -DFFT_KOKKOS_MKL)
  endif()
endif()
