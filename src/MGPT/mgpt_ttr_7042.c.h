...
void ttr_7_8_3_v4r2(const float * restrict A,
...
B0reg1 = _mm_load_ps(&B0[40]) ;
B1reg1 = _mm_load_ps(&B1[40]) ;
B2reg1 = _mm_load_ps(&B2[40]) ;
B0reg1 = _mm_mul_ps(B0reg1,Areg1) ;
T0reg1 = _mm_add_ps(T0reg1,B0reg1) ;
B1reg1 = _mm_mul_ps(B1reg1,Areg1) ;
T1reg1 = _mm_add_ps(T1reg1,B1reg1) ;
...
Areg2 = _mm_load_ps(&A[44]) ;
B0reg2 = _mm_load_ps(&B0[44]) ;
B1reg2 = _mm_load_ps(&B1[44]) ;
B2reg2 = _mm_load_ps(&B2[44]) ;
B0reg2 = _mm_mul_ps(B0reg2,Areg2) ;
T0reg2 = _mm_add_ps(T0reg2,B0reg2) ;
B1reg2 = _mm_mul_ps(B1reg2,Areg2) ;
T1reg2 = _mm_add_ps(T1reg2,B1reg2) ;
...
Areg1 = _mm_load_ps(&A[48]) ;
B0reg1 = _mm_load_ps(&B0[48]) ;
B1reg1 = _mm_load_ps(&B1[48]) ;
B2reg1 = _mm_load_ps(&B2[48]) ;
B0reg1 = _mm_mul_ps(B0reg1,Areg1) ;
T0reg1 = _mm_add_ps(T0reg1,B0reg1) ;
B1reg1 = _mm_mul_ps(B1reg1,Areg1) ;
T1reg1 = _mm_add_ps(T1reg1,B1reg1) ;
...
B0reg2 = _mm_load_ps(&B0[52]) ;
B1reg2 = _mm_load_ps(&B1[52]) ;
B2reg2 = _mm_load_ps(&B2[52]) ;
B0reg2 = _mm_mul_ps(B0reg2,Areg2) ;
T0reg2 = _mm_add_ps(T0reg2,B0reg2) ;
B1reg2 = _mm_mul_ps(B1reg2,Areg2) ;
T1reg2 = _mm_add_ps(T1reg2,B1reg2) ;
