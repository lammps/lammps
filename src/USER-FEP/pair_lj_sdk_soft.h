...
PairStyle(lj/sdk/soft,PairLJSDKSoft)

#else

#ifndef LMP_PAIR_LJ_SDK_SOFT_H
#define LMP_PAIR_LJ_SDK_SOFT_H
...
class PairLJSDKSoft : public Pair {
 public:
  PairLJSDKSoft(LAMMPS *);
  virtual ~PairLJSDKSoft();
