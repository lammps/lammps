if(BUILD_TOOLS)
  ...
  if(BUILD_FORTRAN)
    ...
    message(STATUS "Skipping Fortran tools (chain.x, micelle2d.x): BUILD_FORTRAN is OFF")
  endif()
...
if(BUILD_LAMMPS_GUI)
  ...
  if(BUILD_WHAM)
    ...
    set(WHAM_SHA256 "bc7ce8a79269d80979a06c3593960ed936333435bb71414913fa7b5a138dd2cf" CACHE STRING "SHA256 checksum of WHAM tarball")
