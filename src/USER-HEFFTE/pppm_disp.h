...
------------------------------------------------------------------------- */
  ...
  std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > fft1, fft2;
  std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > fft1_6, fft2_6;
  ...
  virtual void poisson_ik(FFT_SCALAR *, FFT_SCALAR *,
                          FFT_SCALAR *, std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > &, std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > &,
  ...
  virtual void poisson_peratom(FFT_SCALAR*, FFT_SCALAR*, std::unique_ptr< heffte::fft3d<heffte::backend::fftw> > &,
                               double**, double**, int,
                               int, int, int, int, int, int,
                               FFT_SCALAR***, FFT_SCALAR***, FFT_SCALAR***,
                               FFT_SCALAR***, FFT_SCALAR***, FFT_SCALAR***);
