...
in :doc:`the kokkos package doc pages <Speed_kokkos>`, this switch must be set to enable
...
multiple partitions, see :doc:`this doc page <Howto_multiple>`.  
World- and universe-style :doc:`variables <variable>` are useful
in this context.
...
See the :doc:`General tips <Speed_tips>` doc page for more details.
...
index and other kinds of variables and the :doc:`Parsing rules <Commands_parse>` page for more info on using variables in
input scripts.
