...
bool FixPIMDNVTValidated::nuclear_thermostat_off() const
{
...
double FixPIMDNVTValidated::chain0_target_energy() const
{
...
void FixPIMDNVTValidated::initial_integrate(int /*vflag*/)
{
...
void FixPIMDNVTValidated::final_integrate()
{
  force_half_step();
...
void FixPIMDNVTValidated::o_step()
{
...
void FixPIMDNVTValidated::force_half_step()
{
  b_step();
}
...
void FixPIMDNVTValidated::centroid_position_half_step()
{
  qc_step();
}
...
void FixPIMDNVTValidated::nh_v_temp()
{
  double **v = atom->v;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
