.. index:: fix bond/mcmove

fix bond/mcmove command
=====================
...
.. parsed-literal::
   ...
   fix ID group-ID bond/mcmove trackBondType movingBondType Nevery fraction seed

* ID, group-ID are documented in :doc:`fix <fix>` command
* bond/mcmove = style name of this fix command
* trackBondType = bond type to move on
* movingBondType = bond type to consider moving
* Nevery = attempt bond swapping every this many steps
* fraction = fraction of bonds to consider for swapping
...
.. code-block:: LAMMPS
   ...
   fix 1 all bond/mcmove 1 50 0.5 1.3 598934
