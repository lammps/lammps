...
public:
    ...
    */
    ...
    Complex &operator=(const DOUBLE_TYPE &rhs) {
        this->real = rhs;
        this->img = 0.;
        return *this;
    }
...
*/
    ...
    Complex operator*(const Complex &cm2) const {
        Complex res{real * cm2.real - img * cm2.img,
    ...
    DOUBLE_TYPE real_part_product(const Complex &cm2) const {
    ...
    Complex operator*(const DOUBLE_TYPE &cm2) const {
        Complex res{real * cm2,
                    img * cm2};
        return res;
    }

    Complex operator+(const Complex &cm2) const {
        Complex res{real + cm2.real,
                    img + cm2.img};
        return res;
    }

    Complex operator+(const DOUBLE_TYPE &cm2) const {
        Complex res{real + cm2, img};
        return res;
    }
...
public:
    ...
    */
    ...
    Dycomponent operator*(const Complex &rhs) const {
        Dycomponent res;
