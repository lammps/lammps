...
PairLJCharmmCoulCharmmImplicitKokkos<Space>::PairLJCharmmCoulCharmmImplicitKokkos(LAMMPS *lmp):PairLJCharmmCoulCharmmImplicit(lmp)
{
  respa_enable = 0;
...
template<ExecutionSpace Space>
PairLJCharmmCoulCharmmImplicitKokkos<Space>::~PairLJCharmmCoulCharmmImplicitKokkos()
{
  if (!copymode) {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::cleanup_copy() {
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::compute(int eflag_in, int vflag_in)
{
  eflag = eflag_in;
  vflag = vflag_in;
  ...
  EV_FLOAT ev;
  if(ncoultablebits)
    ev = pair_compute<Space,PairLJCharmmCoulCharmmImplicitKokkos<Space>,CoulLongTable<1> >
      (this,(NeighListKokkos<Space>*)list);
  else
    ev = pair_compute<Space,PairLJCharmmCoulCharmmImplicitKokkos<Space>,CoulLongTable<0> >
      (this,(NeighListKokkos<Space>*)list);
...
KK_FLOAT PairLJCharmmCoulCharmmImplicitKokkos<Space>::
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::allocate()
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::init_tables(double cut_coul, double *cut_respa)
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::settings(int narg, char **arg)
{
...
template<ExecutionSpace Space>
void PairLJCharmmCoulCharmmImplicitKokkos<Space>::init_style()
{
...
template<ExecutionSpace Space>
double PairLJCharmmCoulCharmmImplicitKokkos<Space>::init_one(int i, int j)
{
...
namespace LAMMPS_NS {
template class PairLJCharmmCoulCharmmImplicitKokkos<Device>;
template class PairLJCharmmCoulCharmmImplicitKokkos<Host>;
}
