...
DumpStyle(cac/atom,DumpCACAtom)

#else

#ifndef LMP_DUMP_CAC_ATOM_H
#define LMP_DUMP_CAC_ATOM_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpCACAtom : public Dump {
 public:
  DumpCACAtom(class LAMMPS *, int, char**);
  virtual ~DumpCACAtom();
 ...
 protected:
  ...
  int count();
  typedef void (DumpCACAtom::*FnPtrWrite)(int, double *);
