...
Example input scripts available: examples/PACKAGES/phonon/3-3D-FCC-Cu-EAM/in.EAM3D, examples/PACKAGES/phonon/4-Graphene/in.graphene, examples/PACKAGES/phonon/2-1D-diatomic/in.Ana
