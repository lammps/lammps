...
inline void compute(double a, double b,
                    double E_parent, double E_child,
                    int np, int parent_state, int child_state,
                    double *dH, int dH_stride, int nlocal,
                    double &V)
{
...
inline void compute_scalar(double a, double b,
                           double E_parent, double E_child,
                           double &V, double &g)
{
  double dE = E_child - E_parent;
...
inline void compute_scalar_tapered(double a, double b,
                                   double E_parent, double E_child,
                                   double *xH, double *xY,
                                   Domain *domain,
                                   double rm, double rc,
                                   double &V, double &g,
                                   double *taper_fH, double *taper_fY)
{
  double dE = E_child - E_parent;
