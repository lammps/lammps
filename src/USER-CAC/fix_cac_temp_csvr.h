...
FixStyle(cac/temp/csvr,FixTempCSVRCAC)

#else

#ifndef LMP_FIX_TEMP_CSVR_CAC_H
#define LMP_FIX_TEMP_CSVR_CAC_H

#include "fix.h"

namespace LAMMPS_NS {

class FixTempCSVRCAC : public Fix {
 public:
  FixTempCSVRCAC(class LAMMPS *, int, char **);
  ~FixTempCSVRCAC();
  int setmask();
  void init();
  void end_of_step();
