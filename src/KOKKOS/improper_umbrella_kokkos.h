...
// clang-format off
ImproperStyle(umbrella/kk,ImproperUmbrellaKokkos<LMPDeviceType>);
ImproperStyle(umbrella/kk/device,ImproperUmbrellaKokkos<LMPDeviceType>);
ImproperStyle(umbrella/kk/host,ImproperUmbrellaKokkos<LMPHostType>);
// clang-format on
#else

// clang-format off
#ifndef LMP_IMPROPER_UMBRELLA_KOKKOS_H
#define LMP_IMPROPER_UMBRELLA_KOKKOS_H
...
struct TagImproperUmbrellaCompute{};

template<class DeviceType>
class ImproperUmbrellaKokkos : public ImproperUmbrella {
 public:
  typedef DeviceType device_type;
  typedef ArrayTypes<DeviceType> AT;
  typedef EV_FLOAT value_type;

  ImproperUmbrellaKokkos(class LAMMPS *);
  ~ImproperUmbrellaKokkos() override;
...
// NOLINTNEXTLINE
  ...
  void operator()(TagImproperUmbrellaCompute<NEWTON_BOND,EVFLAG>, const int&, EV_FLOAT&) const;

  template<int NEWTON_BOND, int EVFLAG>
// NOLINTNEXTLINE
  KOKKOS_INLINE_FUNCTION
  void operator()(TagImproperUmbrellaCompute<NEWTON_BOND,EVFLAG>, const int&) const;
