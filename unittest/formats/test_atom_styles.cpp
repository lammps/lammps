...
TEST_F(AtomStyleTest, tri)
{
    ...
    EXPECT_NEAR(bonus[0].inertia[2], 14.017974903242481, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[1], 13.94589575227541, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[0], 0.072258416330334363, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[2], 13.982119044342252, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[1], 13.945895752275419, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[0], 0.10811427523057447, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[2], 19.15175691481879, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[1], 18.948744087979005, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[0], 0.23541253382609079, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[2], 19.018309360029388, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[1], 18.948744087979012, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[0], 0.36886008861549813, EPSILON);
    EXPECT_NEAR(bonus[0].quat[0], 0.92373678792937974, EPSILON);
    EXPECT_NEAR(bonus[0].quat[1], 0.0067268233964605136, EPSILON);
    EXPECT_NEAR(bonus[0].quat[2], 0.016239988275423622, EPSILON);
    EXPECT_NEAR(bonus[0].quat[3], -0.38262430562330857, EPSILON);
    EXPECT_NEAR(bonus[1].quat[0], 0.63633478678991862, EPSILON);
    EXPECT_NEAR(bonus[1].quat[1], 0.66894644809679971, EPSILON);
    EXPECT_NEAR(bonus[1].quat[2], 0.26478147716387457, EPSILON);
    EXPECT_NEAR(bonus[1].quat[3], 0.27835132126616718, EPSILON);
    EXPECT_NEAR(bonus[2].quat[0], 0.90191325590647375, EPSILON);
    EXPECT_NEAR(bonus[2].quat[1], 0.2009681312851252, EPSILON);
    EXPECT_NEAR(bonus[2].quat[2], 0.1002758475123109, EPSILON);
    EXPECT_NEAR(bonus[2].quat[3], 0.36892959143125958, EPSILON);
    EXPECT_NEAR(bonus[3].quat[0], 0.34503278332913523, EPSILON);
    EXPECT_NEAR(bonus[3].quat[1], 0.17090845404750615, EPSILON);
    EXPECT_NEAR(bonus[3].quat[2], 0.44689296000042461, EPSILON);
    EXPECT_NEAR(bonus[3].quat[3], 0.80748335033318219, EPSILON);
    EXPECT_NEAR(bonus[0].c1[0], -0.14933690186163626, EPSILON);
    EXPECT_NEAR(bonus[0].c1[2], -0.0052525338293288879, EPSILON);
    EXPECT_NEAR(bonus[1].c1[0], -0.18681344121910512, EPSILON);
    EXPECT_NEAR(bonus[1].c1[2], 0.18561232929671317, EPSILON);
    EXPECT_NEAR(bonus[2].c1[0], -0.78775285695558628, EPSILON);
    EXPECT_NEAR(bonus[2].c1[2], -0.22123552085772158, EPSILON);
    EXPECT_NEAR(bonus[3].c1[0], -0.47901475403318072, EPSILON);
    EXPECT_NEAR(bonus[3].c1[2], -0.69845793336676587, EPSILON);
    EXPECT_NEAR(bonus[0].c2[0], 0.55733290519255363, EPSILON);
    EXPECT_NEAR(bonus[0].c2[2], 0.019602723119529656, EPSILON);
    EXPECT_NEAR(bonus[1].c2[0], -0.22223836695322477, EPSILON);
    EXPECT_NEAR(bonus[1].c2[2], 0.22080949143752887, EPSILON);
    EXPECT_NEAR(bonus[2].c2[0], 0.63043795621810073, EPSILON);
    EXPECT_NEAR(bonus[2].c2[2], 0.17705460333259254, EPSILON);
    EXPECT_NEAR(bonus[3].c2[0], 0.15093208974463557, EPSILON);
    EXPECT_NEAR(bonus[3].c2[2], 0.22007613459534847, EPSILON);
    EXPECT_NEAR(bonus[0].c3[0], -0.4079960033309174, EPSILON);
    EXPECT_NEAR(bonus[0].c3[2], -0.014350189290200809, EPSILON);
    EXPECT_NEAR(bonus[1].c3[0], 0.40905180817232961, EPSILON);
    EXPECT_NEAR(bonus[1].c3[2], -0.40642182073424171, EPSILON);
    EXPECT_NEAR(bonus[2].c3[0], 0.15731490073748589, EPSILON);
    EXPECT_NEAR(bonus[2].c3[2], 0.044180917525128927, EPSILON);
    EXPECT_NEAR(bonus[3].c3[0], 0.32808266428854477, EPSILON);
    EXPECT_NEAR(bonus[3].c3[2], 0.4783817987714174, EPSILON);
    ...
    EXPECT_NEAR(bonus[0].inertia[1], 13.94589575227541, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[0], 0.072258416330334363, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[2], 19.15175691481879, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[1], 18.948744087979005, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[0], 0.23541253382609079, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[2], 14.017974903242481, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[1], 13.94589575227541, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[0], 0.072258416330334363, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[2], 19.15175691481879, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[1], 18.948744087979005, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[0], 0.23541253382609079, EPSILON);
    EXPECT_NEAR(bonus[0].quat[0], 0.92373678792937974, EPSILON);
    EXPECT_NEAR(bonus[0].quat[1], 0.0067268233964605136, EPSILON);
    EXPECT_NEAR(bonus[0].quat[2], 0.016239988275423622, EPSILON);
    EXPECT_NEAR(bonus[0].quat[3], -0.38262430562330857, EPSILON);
    EXPECT_NEAR(bonus[1].quat[0], 0.90191325590647375, EPSILON);
    EXPECT_NEAR(bonus[1].quat[1], 0.2009681312851252, EPSILON);
    EXPECT_NEAR(bonus[1].quat[2], 0.1002758475123109, EPSILON);
    EXPECT_NEAR(bonus[1].quat[3], 0.36892959143125958, EPSILON);
    EXPECT_NEAR(bonus[2].quat[0], 0.92373678792937974, EPSILON);
    EXPECT_NEAR(bonus[2].quat[1], 0.0067268233964605136, EPSILON);
    EXPECT_NEAR(bonus[2].quat[2], 0.016239988275423622, EPSILON);
    EXPECT_NEAR(bonus[2].quat[3], -0.38262430562330857, EPSILON);
    EXPECT_NEAR(bonus[3].quat[0], 0.90191325590647375, EPSILON);
    EXPECT_NEAR(bonus[3].quat[1], 0.2009681312851252, EPSILON);
    EXPECT_NEAR(bonus[3].quat[2], 0.1002758475123109, EPSILON);
    EXPECT_NEAR(bonus[3].quat[3], 0.36892959143125958, EPSILON);
    EXPECT_NEAR(bonus[0].c1[0], -0.14933690186163626, EPSILON);
    EXPECT_NEAR(bonus[0].c1[2], -0.0052525338293288879, EPSILON);
    EXPECT_NEAR(bonus[1].c1[0], -0.78775285695558628, EPSILON);
    EXPECT_NEAR(bonus[1].c1[2], -0.22123552085772158, EPSILON);
    EXPECT_NEAR(bonus[2].c1[0], -0.14933690186163626, EPSILON);
    EXPECT_NEAR(bonus[2].c1[2], -0.0052525338293288879, EPSILON);
    EXPECT_NEAR(bonus[3].c1[0], -0.78775285695558628, EPSILON);
    EXPECT_NEAR(bonus[3].c1[2], -0.22123552085772158, EPSILON);
    EXPECT_NEAR(bonus[0].c2[0], 0.55733290519255363, EPSILON);
    EXPECT_NEAR(bonus[0].c2[2], 0.019602723119529656, EPSILON);
    EXPECT_NEAR(bonus[1].c2[0], 0.63043795621810073, EPSILON);
    EXPECT_NEAR(bonus[1].c2[2], 0.17705460333259254, EPSILON);
    EXPECT_NEAR(bonus[2].c2[0], 0.55733290519255363, EPSILON);
    EXPECT_NEAR(bonus[2].c2[2], 0.019602723119529656, EPSILON);
    EXPECT_NEAR(bonus[3].c2[0], 0.63043795621810073, EPSILON);
    EXPECT_NEAR(bonus[3].c2[2], 0.17705460333259254, EPSILON);
    EXPECT_NEAR(bonus[0].c3[0], -0.4079960033309174, EPSILON);
    EXPECT_NEAR(bonus[0].c3[2], -0.014350189290200809, EPSILON);
    EXPECT_NEAR(bonus[1].c3[0], 0.15731490073748589, EPSILON);
    EXPECT_NEAR(bonus[1].c3[2], 0.044180917525128927, EPSILON);
    EXPECT_NEAR(bonus[2].c3[0], -0.4079960033309174, EPSILON);
    EXPECT_NEAR(bonus[2].c3[2], -0.014350189290200809, EPSILON);
    EXPECT_NEAR(bonus[3].c3[0], 0.15731490073748589, EPSILON);
    EXPECT_NEAR(bonus[3].c3[2], 0.044180917525128927, EPSILON);
...
TEST_F(AtomStyleTest, body_nparticle)
{
    ...
    EXPECT_NEAR(bonus[0].inertia[2], 2.0, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[1], 2.0, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[0], 0.0, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[2], 4.5, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[1], 4.0, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[0], 0.5, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[2], 1.7746273249544022, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[1], 1.67188, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[0], 0.49099767504559777, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[2], 12.0, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[1], 12.0, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[0], 0.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[0], 1.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[1], 0.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[2], 0.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[3], 0.0, EPSILON);
    ...
    EXPECT_NEAR(bonus[3].quat[0], 0.070424771223903379, EPSILON);
    EXPECT_NEAR(bonus[3].quat[1], 0.81345375914352225, EPSILON);
    EXPECT_NEAR(bonus[3].quat[2], 0.56848787755882768, EPSILON);
    EXPECT_NEAR(bonus[3].quat[3], -0.10077135705145905, EPSILON);
    ASSERT_EQ(bonus[0].ilocal, 0);
    ASSERT_EQ(bonus[1].ilocal, 1);
    ASSERT_EQ(bonus[2].ilocal, 2);
    ASSERT_EQ(bonus[3].ilocal, 3);
    ...
    EXPECT_NEAR(bonus[0].inertia[1], 2.0, EPSILON);
    EXPECT_NEAR(bonus[0].inertia[0], 0.0, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[2], 1.7746273249544022, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[1], 1.67188, EPSILON);
    EXPECT_NEAR(bonus[1].inertia[0], 0.49099767504559777, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[2], 2.0, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[1], 2.0, EPSILON);
    EXPECT_NEAR(bonus[2].inertia[0], 0.0, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[2], 1.7746273249544022, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[1], 1.67188, EPSILON);
    EXPECT_NEAR(bonus[3].inertia[0], 0.49099767504559777, EPSILON);
    EXPECT_NEAR(bonus[0].quat[0], 1.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[1], 0.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[2], 0.0, EPSILON);
    EXPECT_NEAR(bonus[0].quat[3], 0.0, EPSILON);
