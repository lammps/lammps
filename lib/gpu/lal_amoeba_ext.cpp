...
int amoeba_gpu_init(const int ntypes, const int max_amtype, const int max_amclass,
  ...
  for (int i=0; i<procs_per_gpu; i++) {
    ...
    if (gpu_rank==i && world_me!=0)
      init_ok =
          AMOEBAMF.init(ntypes, max_amtype, max_amclass, host_pdamp, host_thole, host_dirdamp,
                        host_amtype2class, host_special_hal, host_special_repel, host_special_disp,
                        host_special_mpole, host_special_polar_wscale, host_special_polar_piscale,
                        host_special_polar_pscale, host_csix, host_adisp, nlocal, nall, max_nbors,
                        maxspecial, maxspecial15, cell_size, screen, polar_dscale, polar_uscale);
...
int **amoeba_gpu_precompute(const int ago, const int inum_full, const int nall, double **host_x,
...
void amoeba_gpu_compute_multipole_real(const int ago, const int inum_full, const int nall,
