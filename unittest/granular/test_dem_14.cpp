...
// DEM verification test 14: granular heat conduction between two spheres in static contact.
// All test logic is shared via test_dem_common; the reference systems
// live in tests/dem14-*.yaml.
